...
<html>
<head>
<title>動物之家留言資料修改 - update_anihome_msg_input.jsp</title></head>
...
<FORM METHOD="post" ACTION="anihome_msg.do" name="form1">
    ...
    <tr>
        <td>動物之家編號:</td>
        <td><input type="TEXT" name="aniHome_Id" size="45" value="<%=anihome_msgVO.getAniHome_Id()%>" /></td>
    </tr>
    <tr>
        <td>留言會員編號:</td>
        <td><input type="TEXT" name="mem_Id" size="45" value="<%=anihome_msgVO.getMem_Id()%>" /></td>
    </tr>
    <tr>
        <td>動物之家留言:</td>
