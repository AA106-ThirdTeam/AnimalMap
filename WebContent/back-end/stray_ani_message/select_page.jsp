...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/stray_ani_message/listAllStray_Ani_message.jsp'>List</a> all Stray_Ani_messages. </li> <br><br>
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/stray_ani_message/stray_ani_message.do" name="form1">
...
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/stray_ani_message/addStray_Ani_message.jsp'>Add</a> a new Stray_Ani_message.</li>
</ul>
