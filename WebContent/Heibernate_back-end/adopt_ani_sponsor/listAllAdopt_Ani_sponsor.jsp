...
<%
    ...
    List<Adopt_Ani_sponsorVO> list = adopt_ani_sponsorSvc.getAll();
    pageContext.setAttribute("list",list);
%>
<html>
<head>
<title>所有送養動物贊助資料 - listAllAdopt_Ani_sponsor.jsp</title>
	<!-- BS -->
...
<table class="table table-hover">
    <tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
        <td>
        <h3>所有送養動物贊助資料 - ListAllAdopt_Ani_sponsor.jsp</h3>
...
<table border='1' bordercolor='#CCCCFF' >
    ...
    <!-- END : include page1部分 -->
    <!-- 顯示查詢資料的部分 -->
    <c:forEach var="adopt_ani_sponsorVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
	...
	<td>
		<font color=orange>${adopt_ani_sponsorVO.memVO.mem_Id}</font>
			...
			<td>${adopt_ani_sponsorVO.ado_Ani_Spo_thing}</td>
			<td>${adopt_ani_sponsorVO.ado_Ani_Spo_time}</td>
            <!-- 修改按鈕部分 -->
            <td>
