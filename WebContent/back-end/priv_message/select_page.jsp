...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/priv_message/listAllPriv_message.jsp'>List</a> all Priv_messages. </li> <br><br>
  ...
  <li>
     <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/priv_message/priv_message.do" >
     	<div class="form-group">
	       ...
	       <select size="1" name="privMesSend_MemId">
  ...
  <li>
     <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/priv_message/priv_message.do" >
     	<div class="form-group">
	       ...
	       <select size="1" name="privMesRec_MemId">
	         <c:forEach var="memVO" items="${memSvc.all}" > 
	          <option value="${memVO.mem_Id}">${memVO.mem_Id}
	         </c:forEach>   
	       </select>
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/priv_message/priv_message.do" name="form1">
      <b><font color=blue>萬用複合查詢:</font></b> <br>
       ...
       <br> 
        ...
        <b>發送時間:</b>
        <input class="cal-TextBox" onFocus="this.blur()" size="9" readonly type="text" name="privMes_SendTime" value="">
...
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/priv_message/addPriv_message.jsp'>Add</a> a new Priv_message.</li>
</ul>
