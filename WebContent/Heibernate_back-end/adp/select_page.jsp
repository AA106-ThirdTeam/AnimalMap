...
<table class="table"  border='1' cellpadding='5' cellspacing='0' width='400'>
  <tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
    <td>
    <h3>表格 Adp: Home</h3><font color=red>( MVC )</font>
    </td>
  </tr>
</table>
<hr>
...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/Heibernate_back-end/adp/listAllAdp.jsp'>List</a> all Adps. </li> <br><br>
  <li>
  ...
  <li>
     <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/Heibernate_back-end/adp/adp.do" >
     	<div class="form-group">
	       ...
	       <input type="submit" value="送出">
	       <input type="hidden" name="action" value="listAdps_ByMem_Id_A">
       	</div>
     </FORM>
  </li>
</ul>
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/Heibernate_back-end/adp/adp.do" name="form1">
      <b><font color=blue>萬用複合查詢:</font></b> <br>
       ...
       <br> 
        ...
        >
            <img align="middle" border="0" name="BTN_date"  src="<%=request.getContextPath()%>/Heibernate_back-end/images/btn_date_up.gif" width="22" height="17" alt="領養活動發布時間">
        </a>
        <br>
        <b>領養活動到期時間:</b>
        <input class="cal-TextBox" onFocus="this.blur()" size="9" readonly type="text" name="adp_end_date" value="">
        <a class="so-BtnLink" href="javascript:calClick();return false;" 
        	onmouseover="calSwapImg('BTN_date', 'img_Date_OVER',true);" 
        	onmouseout="calSwapImg('BTN_date', 'img_Date_UP',true);" 
        	onclick="calSwapImg('BTN_date', 'img_Date_DOWN');showCalendar('form1','adp_end_date','BTN_date');return false;"
        >
            <img align="middle" border="0" name="BTN_date"  src="<%=request.getContextPath()%>/Heibernate_back-end/images/btn_date_up.gif" width="22" height="17" alt="領養活動到期時間">
        </a>
        <br>
        <b>領養活動更新時間:</b>
        ...
        >
            <img align="middle" border="0" name="BTN_date"  src="<%=request.getContextPath()%>/Heibernate_back-end/images/btn_date_up.gif" width="22" height="17" alt="領養活動更新時間">
        </a>
        <br>
      <input type="submit" value="送出">
...
<h3>領養活動管理</h3>
<ul>
  <li><a href='<%=request.getContextPath()%>/Heibernate_back-end/adp/addAdp.jsp'>Add</a> a new Adp.</li>
</ul>
<!--  -->
	    <hr>
