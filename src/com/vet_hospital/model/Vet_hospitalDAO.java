...
public class Vet_hospitalDAO implements Vet_hospitalDAO_interface{
	...
	//====以下是單筆資料查詢指令====
	public static final String GET_ONE_STMT = "SELECT hos_Id,mem_Id,hos_name,hos_city,hos_town,hos_road,hos_Eval,hos_URL,hos_StartTime,hos_EndTime,hos_Tel,hos_Desc,hos_Long,hos_Lat,to_char(hos_CreateTime,'yyyy-mm-dd') hos_CreateTime,hos_visible FROM vet_hospital WHERE hos_Id=? " ; 
	//====以下是單筆資料查詢指令====
	public static final String GET_ALL_STMT = "SELECT hos_Id,mem_Id,hos_name,hos_city,hos_town,hos_road,hos_Eval,hos_URL,hos_StartTime,hos_EndTime,hos_Tel,hos_Desc,hos_Long,hos_Lat,to_char(hos_CreateTime,'yyyy-mm-dd') hos_CreateTime,hos_visible FROM vet_hospital order by hos_Id " ; 
	//====以下是新增指令====
