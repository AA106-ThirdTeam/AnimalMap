...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/hosphoto/listAllHosPhoto.jsp'>List</a> all HosPhotos. </li> <br><br>
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/hosphoto/hosphoto.do" name="form1">
...
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/hosphoto/addHosPhoto.jsp'>Add</a> a new HosPhoto.</li>
</ul>
