...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/Heibernate_back-end/adpmsg/listAllAdpMsg.jsp'>List</a> all AdpMsgs. </li> <br><br>
  <li>
...
<h3>領養活動留言管理</h3>
<ul>
  <li><a href='<%=request.getContextPath()%>/Heibernate_back-end/adpmsg/addAdpMsg.jsp'>Add</a> a new AdpMsg.</li>
</ul>
<!--  -->
	    <hr>
