...
<table border='1' cellpadding='5' cellspacing='0' width='800'>
    <tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
        ...
        <a href="<%=request.getContextPath()%>/back-end/emg_help/select_page.jsp">
...
<FORM METHOD="post" ACTION="emg_help.do" name="form1">
    ...
    <tr>
        <td>發起人編號:</td>
        <td><input type="TEXT" name="mem_Id" size="45" value="<%=emg_helpVO.getMem_Id()%>" /></td>
    </tr>
	...
	<tr>
		...
		<td bgcolor="#CCCCFF">
		    ...
		    <img align="middle" border="0" name="BTN_date"	src="<%=request.getContextPath()%>/back-end/images/btn_date_up.gif" width="22" height="17" alt="開始時間"></a>
		</td>
	</tr>
	...
	<tr>
		...
		<td bgcolor="#CCCCFF">
		    ...
		    <img align="middle" border="0" name="BTN_date"	src="<%=request.getContextPath()%>/back-end/images/btn_date_up.gif" width="22" height="17" alt="結束日期"></a>
		</td>
	</tr>
