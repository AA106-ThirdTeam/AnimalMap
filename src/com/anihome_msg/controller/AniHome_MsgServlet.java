	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		if ("getOne_For_Update".equals(action)) {
			...
			try {			
				...
				RequestDispatcher successView = req.getRequestDispatcher(url); // 成功轉交update_anihome_msg_input.jsp
				successView.forward(req, res);
		...
		if ("update".equals(action)) { // 來自update_aniHome_Msg_input.jsp的請求
		...
		if ("delete".equals(action)) { 
			...
			try {
				...
				if(requestURL.equals("/back-end/anihome_msg/listAniHome_Msgs_ByAniHome_Id.jsp") 
					|| requestURL.equals("/back-end/anihome_msg/listAllAniHome_Msg.jsp")){
					req.setAttribute("listAniHome_Msgs_ByAniHome_Id",anihome_msgSvc.getAniHome_MsgsByAniHome_Id(anihome_msgVO.getAniHome_Id())); // 資料庫取出的list物件,存入request
				}

				if(requestURL.equals("/back-end/anihome_msg/listAniHome_Msgs_ByMem_Id.jsp") 
					|| requestURL.equals("/back-end/anihome_msg/listAllAniHome_Msg.jsp")){
					req.setAttribute("listAniHome_Msgs_ByMem_Id",anihome_msgSvc.getAniHome_MsgsByMem_Id(anihome_msgVO.getMem_Id())); // 資料庫取出的list物件,存入request
				}
        ...
        if ("listAniHome_Msgs_ByCompositeQuery".equals(action)) { // 來自select_page.jsp的複合查詢請求
            List<String> errorMsgs = new LinkedList<String>();
            // Store this set in the request scope, in case we need to
            // send the ErrorPage view.
            req.setAttribute("errorMsgs", errorMsgs);
            ...
            try {
                ...
                /***************************3.查詢完成,準備轉交(Send the Success view)************/
                req.setAttribute("listAniHome_Msgs_ByCompositeQuery", list); // 資料庫取出的list物件,存入request
                RequestDispatcher successView = req.getRequestDispatcher("/back-end/anihome_msg/listAniHome_Msgs_ByCompositeQuery.jsp"); // 成功轉交listAniHome_Msgs_ByCompositeQuery.jsp
                successView.forward(req, res);
        ...
        // 來自select_page.jsp的請求                                  // 來自 anihome_msg/listAllAniHome_Msg.jsp的請求
        if ("listAniHome_Msgs_ByAniHome_Id_A".equals(action)) {
            ...
            try {
                ...
                /*************************** 2.開始查詢資料 ****************************************/
                AniHome_MsgService anihome_msgSvc = new AniHome_MsgService();
                Set<AniHome_MsgVO> set = anihome_msgSvc.getAniHome_MsgsByAniHome_Id(aniHome_Id);

                /*************************** 3.查詢完成,準備轉交(Send the Success view) ************/
                req.setAttribute("listAniHome_Msgs_ByAniHome_Id", set);    // 資料庫取出的list物件,存入request

                String url = null;
                if ("listAniHome_Msgs_ByAniHome_Id_A".equals(action))
                    url = "/back-end/anihome_msg/listAniHome_Msgs_ByAniHome_Id.jsp";        // 成功轉交 anihome_msg/listAniHome_Msgs_ByAniHome_Id.jsp
        ...
        // 來自select_page.jsp的請求                                  // 來自 anihome_msg/listAllAniHome_Msg.jsp的請求
        if ("listAniHome_Msgs_ByMem_Id_A".equals(action)) {
            ...
            try {
                ...
                /*************************** 2.開始查詢資料 ****************************************/
                AniHome_MsgService anihome_msgSvc = new AniHome_MsgService();
                Set<AniHome_MsgVO> set = anihome_msgSvc.getAniHome_MsgsByMem_Id(mem_Id);

                /*************************** 3.查詢完成,準備轉交(Send the Success view) ************/
                req.setAttribute("listAniHome_Msgs_ByMem_Id", set);    // 資料庫取出的list物件,存入request

                String url = null;
                if ("listAniHome_Msgs_ByMem_Id_A".equals(action))
                    url = "/back-end/anihome_msg/listAniHome_Msgs_ByMem_Id.jsp";        // 成功轉交 anihome_msg/listAniHome_Msgs_ByMem_Id.jsp
