...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/hos_comment/listAllHos_comment.jsp'>List</a> all Hos_comments. </li> <br><br>
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/hos_comment/hos_comment.do" name="form1">
      <b><font color=blue>萬用複合查詢:</font></b> <br>
       ...
       <br> 
        ...
        <b>發送時間:</b>
        <input class="cal-TextBox" onFocus="this.blur()" size="9" readonly type="text" name="hosComment_SendTime" value="">
        ...
        >
            <img align="middle" border="0" name="BTN_date"  src="<%=request.getContextPath()%>/back-end/images/btn_date_up.gif" width="22" height="17" alt="發送時間">
        </a>
        <br>
...
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/hos_comment/addHos_comment.jsp'>Add</a> a new Hos_comment.</li>
</ul>
...
<!--  -->
	    ...
	    <ul>
	      <li><a href='<%=request.getContextPath()%>/back-end/vet_hospital/listAllVet_hospital.jsp'>List</a> all Vet_hospitals. </li>
	    </ul>
