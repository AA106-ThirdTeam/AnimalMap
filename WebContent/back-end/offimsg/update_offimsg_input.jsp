...
<head>
	...
	<title>公告訊息資料修改 - update_offimsg_input.jsp</title>
...
<FORM METHOD="post" ACTION="offimsg.do" name="form1">
	...
	<tr>
		...
		<td bgcolor="#CCCCFF">
		    ...
		    <img align="middle" border="0" name="BTN_date"	src="<%=request.getContextPath()%>/back-end/images/btn_date_up.gif" width="22" height="17" alt="訊息發布時間"></a>
		</td>
	</tr>
