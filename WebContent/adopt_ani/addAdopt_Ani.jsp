...
<html>
<head>
<title>送養動物新增 - addAdopt_Ani.jsp</title></head>
...
<table border='1' cellpadding='5' cellspacing='0' width='800'>
	<tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
		...
		<td>
		   <a href="<%=request.getContextPath()%>/adopt_ani/select_page.jsp"><img src="<%=request.getContextPath()%>/images/tomcat.gif" width="100" height="100" border="1">回首頁</a>
	    </td>
	</tr>
</table>
...
<table border="0">
	<tr>
		...
		<td><input type="TEXT" name="mem_Id" size="45"
			value="<%= (adopt_aniVO==null)? "1" : adopt_aniVO.getMem_Id()%>" /></td>
	</tr>
	<tr>
		<td>送養動物名字:</td>
	...
	<tr>
		...
		<td bgcolor="#CCCCFF">
		    ...
		    <img align="middle" border="0" name="BTN_date"	src="<%=request.getContextPath()%>/images/btn_date_up.gif" width="22" height="17" alt="送養時間"></a>
		</td>
	</tr>
	<tr>
		<td>送養動物物件狀態:</td>
	...
	<tr>
		...
		<td bgcolor="#CCCCFF">
		    ...
		    <img align="middle" border="0" name="BTN_date"	src="<%=request.getContextPath()%>/images/btn_date_up.gif" width="22" height="17" alt="送養動物建立時間"></a>
		</td>
	</tr>
	<tr>
		<td>送養地點經度:</td>
