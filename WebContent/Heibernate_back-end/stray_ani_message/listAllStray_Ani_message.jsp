...
<%
    ...
    List<Stray_Ani_messageVO> list = stray_ani_messageSvc.getAll();
    pageContext.setAttribute("list",list);
%>
<html>
<head>
<title>所有社區流浪動物留言資料 - listAllStray_Ani_message.jsp</title>
	<!-- BS -->
...
<table class="table table-hover">
    <tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
        <td>
        <h3>所有社區流浪動物留言資料 - ListAllStray_Ani_message.jsp</h3>
...
<table border='1' bordercolor='#CCCCFF' >
    ...
    <!-- END : include page1部分 -->
    <!-- 顯示查詢資料的部分 -->
    <c:forEach var="stray_ani_messageVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
