 ...
 *	英文:adoAniSpo<br>
 */ 
@WebServlet(urlPatterns = { "/adoanispo/adoanispo.do" })
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		if ("getOne_For_Display".equals(action)) { 
			...
			try {
				...
				String url = "/adoanispo/listOneAdoAniSpo.jsp";
		...
		if ("getOne_For_Update".equals(action)) {
			...
			try {
				...
				/***************************3.查詢完成,準備轉交(Send the Success view)*************/
				req.setAttribute("adoanispoVO", adoanispoVO); 
				String url = "/adoanispo/update_adoanispo_input.jsp";
				RequestDispatcher successView = req.getRequestDispatcher(url); 
				successView.forward(req, res);
		...
		if ("update".equals(action)) {
			...
			try {
				...
				/***************************2.開始修改資料*****************************************/
				AdoAniSpoService adoanispoSvc = new AdoAniSpoService();
				adoanispoVO = adoanispoSvc.updateAdoAniSpo(adoAniSpoNo,adoAniSpoAniId,adoAniSpomem_Id,adoAniSpoMoney,adoAniSpoMat);
			...
			/***************************其他可能的錯誤處理*************************************/
				...
				RequestDispatcher failureView = req.getRequestDispatcher("/adoanispo/update_adoanispo_input.jsp");
				failureView.forward(req, res);
			}
		}
        if ("insert".equals(action)) { // 來自addAdoAniSpo.jsp的請求  
			...
			try {
                ...
                if (!errorMsgs.isEmpty()) {
                    ...
                    RequestDispatcher failureView = req.getRequestDispatcher("/adoanispo/addAdoAniSpo.jsp");
                    failureView.forward(req, res);
                    return;
                }
                ...
                /***************************2.開始新增資料***************************************/
                AdoAniSpoService adoanispoSvc = new AdoAniSpoService();
                adoanispoVO = adoanispoSvc.addAdoAniSpo(adoAniSpoAniId,adoAniSpomem_Id,adoAniSpoMoney,adoAniSpoMat); 
                     
				/***************************3.新增完成,準備轉交(Send the Success view)***********/
				String url = "/adoanispo/listAllAdoAniSpo.jsp";
			...
			/***************************其他可能的錯誤處理**********************************/
				...
				RequestDispatcher failureView = req
						.getRequestDispatcher("/adoanispo/addAdoAniSpo.jsp");
				failureView.forward(req, res);
			}
		}
        if ("delete".equals(action)) { // 來自listAllAdoAniSpo.jsp 或  /dept/listAdoAniSpos_ByDeptno.jsp的請求
            ...
            String requestURL = req.getParameter("requestURL"); // 送出刪除的來源網頁路徑: 可能為【/adoanispo/listAllAdoAniSpo.jsp】 或  【/dept/listAdoAniSpos_ByDeptno.jsp】 或 【 /dept/listAllDept.jsp】 或 【 /adoanispo/listAdoAniSpos_ByCompositeQuery.jsp】
