...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/adopt_ani_message/listAllAdopt_Ani_message.jsp'>List</a> all Adopt_Ani_messages. </li> <br><br>
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/adopt_ani_message/adopt_ani_message.do" name="form1">
...
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/adopt_ani_message/addAdopt_Ani_message.jsp'>Add</a> a new Adopt_Ani_message.</li>
</ul>
