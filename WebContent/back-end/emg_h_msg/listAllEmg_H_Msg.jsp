...
<html>
<head>
<title>所有緊急求救留言資料 - listAllEmg_H_Msg.jsp</title>
	<!-- BS -->
...
<table class="table table-hover">
    <tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
        ...
        <a href="<%=request.getContextPath()%>/back-end/emg_h_msg/select_page.jsp">
...
<table border='1' bordercolor='#CCCCFF' >
    ...
    <!-- 顯示查詢資料的部分 -->
    <c:forEach var="emg_h_msgVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
