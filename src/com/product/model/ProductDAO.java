...
public class ProductDAO implements ProductDAO_interface{
	...
	//====以下是一般指令====
	public static final String INSERT_STMT = "INSERT INTO product(product_no,product_name,product_introduction,product_price,product_stock,product_picture_large,product_picture_small,product_status,product_create_date,product_info,product_kind_no ) VALUES  ( product_seq1.nextval , ? , ? , ? , ? , ? , ? , ? , ? , ? , ?  )  " ; 
	//====以下是更新指令====
	...
	//====以下是單筆資料查詢指令====
	public static final String GET_ONE_STMT = "SELECT product_no,product_name,product_introduction,product_price,product_stock,product_picture_large,product_picture_small,product_status,to_char(product_create_date,'yyyy-mm-dd') product_create_date,product_info,product_kind_no FROM product WHERE product_no=? " ; 
	//====以下是單筆資料查詢指令====
	public static final String GET_ALL_STMT = "SELECT product_no,product_name,product_introduction,product_price,product_stock,product_picture_large,product_picture_small,product_status,to_char(product_create_date,'yyyy-mm-dd') product_create_date,product_info,product_kind_no FROM product order by product_no " ; 
	//====以下是新增指令====
	...
	public void update(ProductVO aProductVO){
		...
		try {
			...
			pstmt.setString (9, aProductVO.getProduct_info());
			pstmt.setInt (10, aProductVO.getProduct_kind_no());
			pstmt.setString (11, aProductVO.getProduct_no());
			pstmt.executeUpdate();
		} catch (SQLException se) {
			throw new RuntimeException("A database error occured. " + se.getMessage());
		} finally {
	...
	@Override
	public ProductVO findByPrimaryKey(String  aPK_NO){
