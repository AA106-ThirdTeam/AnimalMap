...
<%
    ...
    List<Grp_commentVO> list = grp_commentSvc.getAll();
    pageContext.setAttribute("list",list);
%>
<html>
<head>
<title>所有揪團留言資料 - listAllGrp_comment.jsp</title>
	<!-- BS -->
...
<table class="table table-hover">
    <tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
        <td>
        <h3>所有揪團留言資料 - ListAllGrp_comment.jsp</h3>
...
<table border='1' bordercolor='#CCCCFF' >
    <tr align='center' valign='middle'>
		<td><b>揪團留言編號</b></td>		<td><b>發送會員</b></td>		<td><b>揪團</b></td>		<td><b>發送內容</b></td>		<td><b>發送時間</b></td>    
        <td><b>修改</b></td>
        <td><b>刪除</b></td>
    </tr>
    <!-- include page1部分 -->
    ...
    <!-- END : include page1部分 -->
    <!-- 顯示查詢資料的部分 -->
    <c:forEach var="grp_commentVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
