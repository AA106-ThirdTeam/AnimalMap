...
<table class="table"  border='1' cellpadding='5' cellspacing='0' width='400'>
  <tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
    <td>
    <h3>表格 PetGroup: Home</h3><font color=red>( MVC )</font>
    </td>
  </tr>
</table>
<hr>
...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/Heibernate_back-end/petgroup/listAllPetGroup.jsp'>List</a> all PetGroups. </li> <br><br>
  <li>
  ...
  <li>
     <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/Heibernate_back-end/petgroup/petgroup.do" >
     	<div class="form-group">
	       ...
	       <input type="submit" value="送出">
	       <input type="hidden" name="action" value="listPetGroups_ByMem_Id_A">
       	</div>
     </FORM>
  </li>
</ul>
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/Heibernate_back-end/petgroup/petgroup.do" name="form1">
...
<h3>揪團管理</h3>
<ul>
  <li><a href='<%=request.getContextPath()%>/Heibernate_back-end/petgroup/addPetGroup.jsp'>Add</a> a new PetGroup.</li>
</ul>
<!--  -->
	    <hr>
