...
<FORM METHOD="post" ACTION="hos_comment.do" name="form1">
    ...
    <tr>
        <td>發送會員編號:</td>
        <td><input type="TEXT" name="hosComment_MemId" size="45" value="<%=hos_commentVO.getHosComment_MemId()%>" /></td>
    </tr>
	
    <tr>
        <td>診所編號:</td>
        <td><input type="TEXT" name="hosComment_HosId" size="45" value="<%=hos_commentVO.getHosComment_HosId()%>" /></td>
    </tr>
