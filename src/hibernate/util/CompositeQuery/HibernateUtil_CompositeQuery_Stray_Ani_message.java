...
public class HibernateUtil_CompositeQuery_Stray_Ani_message {
	...
	public static List<Stray_Ani_messageVO> getAllC(Map<String, String[]> map) {
...
//		map.put("str_Ani_Mes_No", new String[] { "7001" });	
//		map.put("stray_Ani_Id", new String[] { "7001" });	
//		map.put("mem_Id", new String[] { "7001" });	
//		map.put("str_Ani_Mes_time", new String[] { "7001" });	
//		map.put("str_Ani_Mes", new String[] { "7001" });	

//		map.put("action", new String[] { "getXXX" }); //注意Map裡面會含有action的key
		List<Stray_Ani_messageVO> list = getAllC(map);
		for (Stray_Ani_messageVO aEmp : list) {
			//System.out.print(aEmp.getStr_Ani_Mes_No() + ",");
			//System.out.print(aEmp.getStray_Ani_Id() + ",");
			//System.out.print(aEmp.getMem_Id() + ",");
			//System.out.print(aEmp.getStr_Ani_Mes_time() + ",");
			//System.out.print(aEmp.getStr_Ani_Mes() + ",");
			System.out.println();
		}
	}
}
