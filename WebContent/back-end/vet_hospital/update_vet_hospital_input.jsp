...
<head>
	...
	<title>診所資料修改 - update_vet_hospital_input.jsp</title>
...
<FORM METHOD="post" ACTION="vet_hospital.do" name="form1">
    ...
    <tr>
        <td>會員編號(負責人):</td>
        <td><input type="TEXT" name="hos_MemId" size="45" value="<%=vet_hospitalVO.getHos_MemId()%>" /></td>
    </tr>
	...
	<tr>
		...
		<td bgcolor="#CCCCFF">
		    ...
		    <img align="middle" border="0" name="BTN_date"	src="<%=request.getContextPath()%>/back-end/images/btn_date_up.gif" width="22" height="17" alt="建立時間"></a>
		</td>
	</tr>
