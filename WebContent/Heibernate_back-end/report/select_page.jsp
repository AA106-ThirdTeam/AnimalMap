...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/Heibernate_back-end/report/report.do" name="form1">
      <b><font color=blue>萬用複合查詢:</font></b> <br>
       ...
       <br> 
        <b>檢舉時間:</b>
        <input class="cal-TextBox" onFocus="this.blur()" size="9" readonly type="text" name="report_time" value="">
        ...
        >
            <img align="middle" border="0" name="BTN_date"  src="<%=request.getContextPath()%>/Heibernate_back-end/images/btn_date_up.gif" width="22" height="17" alt="檢舉時間">
        </a>
        <br>
      <input type="submit" value="送出">
