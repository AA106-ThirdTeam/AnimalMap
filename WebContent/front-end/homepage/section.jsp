...
<!-- 		<button type="button" id="AM_Friend" class="btn btn-primary">討論版</button> -->
        ...
        <a href="#" class="btn btn-danger btn-lg" onclick="switchAddBar();">
          ...
          <div class="container" id="addbar" style="background-color: rgba(38, 35, 35, 0); height:400px; width:40px; position:relative; padding-top:0px; padding-left:0px;padding-right:0px" hidden>
          	...
          	<div class="row" style="height:55px;"><img id="" ALT="新增動物醫院" title="新增動物醫院" src="<%=request.getContextPath()%>/front-end/homepage/imgs/172011.png" width="45" height="45" padding-left="0"  onclick="addObjectIntoMap(4)"> </div>
