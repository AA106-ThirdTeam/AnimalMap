...
import jdbc.util.CompositeQuery.jdbcUtil_CompositeQuery_Pet_Message;
/** 
 *表格名稱 : <br>
 *	自家寵物留言<br>
 *	英文:pet_Message<br>
...
public class Pet_MessageDAO implements Pet_MessageDAO_interface{
	...
	//====以下是GET_ByFK_STMT指令====
    private static final String GET_Pet_Messages_ByPet_Id_STMT = 
		"SELECT pet_Mes_No,pet_Id,mem_Id,pet_Mes,to_char(pet_Mes_time,'yyyy-mm-dd') pet_Mes_time FROM Pet_Message WHERE pet_Id = ? order by pet_Id";
    private static final String GET_Pet_Messages_ByMem_Id_STMT = 
		"SELECT pet_Mes_No,pet_Id,mem_Id,pet_Mes,to_char(pet_Mes_time,'yyyy-mm-dd') pet_Mes_time FROM Pet_Message WHERE mem_Id = ? order by mem_Id";
    ...
    public List<Pet_MessageVO> getAll(Map<String, String[]> map) {
        ...
        try {
            ...
            con = ds.getConnection();
            String finalSQL = "select * from Pet_Message "
                  + jdbcUtil_CompositeQuery_Pet_Message.get_WhereCondition(map)
                  + "order by pet_Mes_No";
            ...
            while (rs.next()) {
                ...
                list.add(pet_messageVO); // Store the row in the List
            }
    ...
    public Set<Pet_MessageVO> getPet_MessagesByPet_Id(String pet_Id) {
        Set<Pet_MessageVO> set = new LinkedHashSet<Pet_MessageVO>();
        Pet_MessageVO pet_messageVO = null;
        ...
        try {
            ...
            con = ds.getConnection();
            pstmt = con.prepareStatement(GET_Pet_Messages_ByPet_Id_STMT);
            ...
            while (rs.next()) {
                ...
                set.add(pet_messageVO); // Store the row in the vector
            }
    ...
    public Set<Pet_MessageVO> getPet_MessagesByMem_Id(String mem_Id) {
        ...
        try {
            ...
            con = ds.getConnection();
            pstmt = con.prepareStatement(GET_Pet_Messages_ByMem_Id_STMT);
