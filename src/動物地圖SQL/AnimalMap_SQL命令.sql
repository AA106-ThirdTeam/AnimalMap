...
ALTER TABLE adopt_Ani MODIFY ADOPT_ANI_LIKE DEFAULT 0;
ALTER TABLE stray_Ani MODIFY Stray_ANI_LIKE DEFAULT 0;
...
CREATE TABLE second_ProdPhotos (second_ProdPhotos_Id VARCHAR2(8),second_Prod_Id VARCHAR2(8) NOT NULL ,second_ProdPhotos_Pic BLOB );
...
CREATE TABLE adp (adp_Id VARCHAR2(8),mem_Id VARCHAR2(8),adp_title VARCHAR2(3000),adp_adp_content VARCHAR2(3000),adp_start_date DATE,adp_end_date DATE,adp_upDate DATE,adp_city VARCHAR2(12),adp_town VARCHAR2(12),adp_road VARCHAR2(50),adp_addr CLOB,adp_lon NUMBER(9,6),adp_lat NUMBER(9,6),adp_adp_pic CLOB );
CREATE TABLE park (park_Id VARCHAR2(8),emp_No VARCHAR2(8),park_title VARCHAR2(3000),park_content VARCHAR2(3000),park_pic CLOB,park_start_date DATE,park_upDate DATE,park_city VARCHAR2(12),park_town VARCHAR2(12),park_road VARCHAR2(50),park_lon NUMBER(9,6),park_lat NUMBER(9,6) );
...
CREATE TABLE aniHome (aniHome_Id VARCHAR2(8),mem_Id VARCHAR2(8),aniHome_title VARCHAR2(3000) NOT NULL ,aniHome_content VARCHAR2(3000) NOT NULL ,aniHome_start_date DATE NOT NULL ,aniHome_upDate DATE,aniHome_city VARCHAR2(12),aniHome_town VARCHAR2(12),aniHome_road VARCHAR2(50),aniHome_addr VARCHAR2(300),aniHome_lon NUMBER(9,6),aniHome_lat NUMBER(9,6),aniHome_pic CLOB );
