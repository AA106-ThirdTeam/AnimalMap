...
<%
    ...
    List<AniHomeVO> list_anihome =(List)session.getAttribute("list_aniHome");
    //pageContext.setAttribute("list_anihome",list_anihome);
    int anihome_map_icon_size = 48;
%>
<style>
...
%>
<div id=ex_animal_map_aniHome_<%=vo.getAniHome_Id()%> value="<%=vo.getAniHome_Id()%>" hidden>
...
// 					    // 標記 ID
// 					    // Custom ID
					    id: 'marker_anihome_<%=vo.getAniHome_Id()%>'
					    ,index:'<%=vo.getAniHome_Id()%>'
					    ,type:'anihome'
// 					    // 標記的位置
// 					    // Marker location
