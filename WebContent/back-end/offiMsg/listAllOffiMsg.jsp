...
<body bgcolor='white'>
	...
	<table border='1' cellpadding='5' cellspacing='0' width='800'>
		<tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
			<td>
				<h3>所有訊息資料 - listAllOffiMsg.jsp</h3> <a
				href="<%=request.getContextPath()%>/back-end/offiMsg/select_page.jsp"><img
	...
	<table border='1' bordercolor='#CCCCFF' width='800'>
		...
		<c:forEach var="offiMsgVO" items="${list}" begin="<%=pageIndex%>"
			end="<%=pageIndex+rowsPerPage-1%>">
			<tr align='center' valign='middle'
				${(offiMsgVO.offiMsg_Id==param.offiMsg_Id) ? 'bgcolor=#CCCCFF':''}>
				<!--將修改的那一筆加入對比色而已-->
				...
				<td>
					<FORM METHOD="post"
						ACTION="<%=request.getContextPath()%>/back-end/offiMsg/offiMsg.do">
						<input type="submit" value="修改"> <input type="hidden"
							name="offiMsg_Id" value="${offiMsgVO.offiMsg_Id}"> <input
