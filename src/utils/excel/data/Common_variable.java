	...
	static{
		...
		//==== table名稱 : stray_Ani ====
		{
			...
			//====第 21 列====
			{
				...
				//====欄====
				col_List.add("不指定"); //====第1欄====  
				col_List.add("stray_Ani_like"); //====第2欄====  
