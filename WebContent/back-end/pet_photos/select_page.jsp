...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/pet_photos/listAllPet_Photos.jsp'>List</a> all Pet_Photoss. </li> <br><br>
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/pet_photos/pet_photos.do" name="form1">
...
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/pet_photos/addPet_Photos.jsp'>Add</a> a new Pet_Photos.</li>
</ul>
