...
<table border='1' cellpadding='5' cellspacing='0' width='800'>
	<tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
		...
		<td>
		   <a href="<%=request.getContextPath()%>/Heibernate_back-end/emp/select_page.jsp"><img src="<%=request.getContextPath()%>/images/tomcat.gif" width="100" height="100" border="1">回首頁</a>
	    </td>
	</tr>
</table>
<h3>員工:</h3>
...
<table border="0">
	...
	<tr>
		<td>員工身分證:</td>
		<td><input type="TEXT" name="emp_identity_card" size="45"
			value="<%= (empVO==null)? "1" : empVO.getEmp_identity_card()%>" /></td>
	</tr>	
	<tr>
		...
		<td bgcolor="#CCCCFF">
		    ...
		    <img align="middle" border="0" name="BTN_date"	src="/Excel2MVC/Heibernate_back-end/images/btn_date_up.gif" width="22" height="17" alt="員工出生年月日"></a>
		</td>
	</tr>
	<tr>
		<td>員工電話:</td>
	...
	<tr>
		...
		<td bgcolor="#CCCCFF">
		    ...
		    <img align="middle" border="0" name="BTN_date"	src="/Excel2MVC/Heibernate_back-end/images/btn_date_up.gif" width="22" height="17" alt="雇用日期"></a>
		</td>
	</tr>
	<tr>
		...
		<td bgcolor="#CCCCFF">
		    ...
		    <img align="middle" border="0" name="BTN_date"	src="/Excel2MVC/Heibernate_back-end/images/btn_date_up.gif" width="22" height="17" alt="離職日期"></a>
		</td>
	</tr>
</table>
<br>
