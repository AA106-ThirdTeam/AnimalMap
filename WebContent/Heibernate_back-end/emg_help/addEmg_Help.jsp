...
<table border='1' cellpadding='5' cellspacing='0' width='800'>
	<tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
		...
		<td>
		   <a href="<%=request.getContextPath()%>/Heibernate_back-end/emg_help/select_page.jsp"><img src="<%=request.getContextPath()%>/images/tomcat.gif" width="100" height="100" border="1">回首頁</a>
	    </td>
	</tr>
</table>
<h3>緊急求救:</h3>
...
<table border="0">
	...
	<tr>
		...
		<td><select size="1" name="mem_Id">
			<c:forEach var="memVO" items="${memSvc.all}">
				<option value="${memVO.mem_Id}" ${(emg_helpVO.memVO.mem_Id==memVO.mem_Id)? 'selected':'' } >${memVO.mem_Id}
			</c:forEach>
		</select></td>
	</tr>
	<tr>
	...
	<tr>
		<td>檢舉狀態:</td>
		<td><input type="TEXT" name="emg_H_status" size="45"
			value="<%= (emg_helpVO==null)? "1" : emg_helpVO.getEmg_H_status()%>" /></td>
	</tr>	
</table>
<br>
