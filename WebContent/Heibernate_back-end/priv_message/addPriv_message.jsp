...
<html>
<head>
<title>私人訊息新增 - addPriv_message.jsp</title>
...
<table border='1' cellpadding='5' cellspacing='0' width='800'>
	<tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
		...
		<td>
		   <a href="<%=request.getContextPath()%>/Heibernate_back-end/priv_message/select_page.jsp"><img src="<%=request.getContextPath()%>/images/tomcat.gif" width="100" height="100" border="1">回首頁</a>
	    </td>
	</tr>
</table>
<h3>私人訊息:</h3>
...
<table border="0">
	...
	<tr>
		...
		<td><select size="1" name="mem_Id">
			<c:forEach var="memVO" items="${memSvc.all}">
				<option value="${memVO.mem_Id}" ${(priv_messageVO.memVO.mem_Id==memVO.mem_Id)? 'selected':'' } >${memVO.mem_Id}
			</c:forEach>
		</select></td>
	</tr>
	<tr>
	...
	<tr>
		<td>訊息內容:</td>
		<td><input type="TEXT" name="privMsg_content" size="45"
	...
	<tr>
		...
		<td bgcolor="#CCCCFF">
			...
			onFocus="this.blur()" size="9" readonly type="text" name="privMsg_SendTime" value="<%= (priv_messageVO==null)? date_privMsg_SendTime : priv_messageVO.getPrivMsg_SendTime()%>">
			<a class="so-BtnLink"
	...
	<tr>
		<td>訊息類別:</td>
		<td><input type="TEXT" name="privMsg_type" size="45"
			value="<%= (priv_messageVO==null)? "1" : priv_messageVO.getPrivMsg_type()%>" /></td>
	</tr>	
</table>
<br>
