	...
	<div class="w3-content" style="max-width: 1400px">
		...
		<div class="w3-row">
			...
			<div class="w3-col l8 s12">
				...
				Post_ResponseVO  post_response = (Post_ResponseVO)request.getAttribute("Post_ResponseVO");
				Post_ResponseService postRes = new Post_ResponseService();
				List<Post_ResponseVO> list = postRes.getAll();
				...
				<div class="w3-card-4 w3-margin w3-white">
					...
					<div class="w3-container w3-padding-8">
						<h3>
							發文者 : <a href="#" style="color: rgba(255, 0, 0, 0.49);"><%=post.getMem_Id()%></a>
						</h3>
						<h5>
							<%=post.getPost_title()%>, <span class="w3-opacity"><%=post.getPost_time()%></span>
						</h5>
					</div>
						...
						<div class="w3-row">
							<div class="w3-col m8 s12">
								...
								<FORM METHOD="post"
									...
									<input type="submit" value="返回文章 »"
										class="w3-btn w3-padding-large w3-white w3-border w3-hover-border-black">

									<input type="hidden" name="post_Id"
										value="<%=post.getPost_Id()%>"> <input type="hidden"
										name="action" value="listPost_Responses_ByPost_Id_A">
								</FORM>
								</p>
							</div>
...
<!--
						...
						<div class="row">
							<div class="col-xs-12 col-sm12">
								<form method="post" action="post_Response.do">
				...
				<td><select size="1" name="mem_Id">
					...
					<td><select size="1" name="post_Id">
						...
						value="<%=(post_response == null) ? "000":post_response.getPost_Id()%>"></textarea>
									...
									%>
									<input type="hidden" name="post_time" value="<%=date_SQL%>">
									<br> <input type="hidden" name="post_Response_upDate"
										value="<%=date_SQL%>"> <br> <input type="hidden"
