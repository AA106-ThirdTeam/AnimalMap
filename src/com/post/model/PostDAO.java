...
public class PostDAO implements PostDAO_interface{
	...
	//====以下是一般指令====
	public static final String INSERT_STMT = "INSERT INTO (post_Id,mem_Id,post_class,post_class_Id,post_title,post_content,post_time,post_upDate,post_resNum ) VALUES  ( post_seq1.nextval , ? , ? , ? , ? , ? , ? , ? , ?  )  " ; 
	//====以下是更新指令====
