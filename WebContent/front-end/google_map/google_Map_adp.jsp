...
<div id=ex_animal_map_adp_<%=tem_int%> value="<%=tem_int%>" hidden>
        ...
        <hr>
        <button onclick="show_adp_details_page('<%=vo.getAdp_Id()%>')"
...
<script type="text/javascript">
	function show_adp_details_page(pk_value) {
		var path_parameter = 'action=getOne_For_Display&Id=' + pk_value;
		var src='<%=request.getContextPath()%>/Heibernate_front-end/marker_detail_infowindow/adp_detail_page.jsp?'+path_parameter 
