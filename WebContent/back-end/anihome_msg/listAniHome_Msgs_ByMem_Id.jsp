...
<jsp:useBean id="listAniHome_Msgs_ByMem_Id" scope="request" type="java.util.Set" />

<html>
<head>
<title>留言會員編號 - listAniHome_Msgs_ByMem_Id.jsp</title>
	<!-- 共用HEAD -->
...
<table border='1' cellpadding='5' cellspacing='0' width='800'>
    <tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
        <td>
        <h3>留言會員編號 - listAniHome_Msgs_ByMem_Id.jsp</h3>
...
<table border='1' bordercolor='#CCCCFF' width='800'>
    ...
    <c:forEach var="anihome_msgVO" items="${listAniHome_Msgs_ByMem_Id}" >    
        <tr>
