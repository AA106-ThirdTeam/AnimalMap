...
public class MemJDBCDAO implements MemDAO_interface {
	...
	public void insert(MemVO aMemVO) {
		...
		try {
			...
			String str = "INSERT INTO mem "
					+ "(memId,memAccount,memPsw,memName,memGender,memTwId,memBirthDate,memPhone,memLiveBudget,memIntro,memProfile,memBlackList,memCreditCardNo,memCreditCheckNo,memCreditDueDate)"
