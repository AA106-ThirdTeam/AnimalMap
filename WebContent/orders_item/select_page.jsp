...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/orders_item/orders_item.do" name="form1">
...
<!--  -->
    ...
    <ul>
      <li><a href='<%=request.getContextPath()%>/orders/listAllOrders.jsp'>List</a> all Orderss. </li>
    </ul>

    <hr>

    <h3><font color=orange>商品管理</font></h3>

    <ul>
      <li><a href='<%=request.getContextPath()%>/product/listAllProduct.jsp'>List</a> all Products. </li>
    </ul>
