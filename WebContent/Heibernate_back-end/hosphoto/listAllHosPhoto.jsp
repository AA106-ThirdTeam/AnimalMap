...
<%
    ...
    List<HosPhotoVO> list = hosphotoSvc.getAll();
    pageContext.setAttribute("list",list);
%>
<html>
<head>
<title>所有診所相片資料 - listAllHosPhoto.jsp</title>
	<!-- BS -->
...
<table class="table table-hover">
    <tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
        <td>
        <h3>所有診所相片資料 - ListAllHosPhoto.jsp</h3>
...
<table border='1' bordercolor='#CCCCFF' >
    ...
    <!-- END : include page1部分 -->
    <!-- 顯示查詢資料的部分 -->
    <c:forEach var="hosphotoVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
