...
<html>
<head>
<title>揪團留言新增 - addGrp_comment.jsp</title></head>
...
<table border='1' cellpadding='5' cellspacing='0' width='800'>
	<tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
		...
		<td>
		   <a href="<%=request.getContextPath()%>/grp_comment/select_page.jsp"><img src="<%=request.getContextPath()%>/images/tomcat.gif" width="100" height="100" border="1">回首頁</a>
	    </td>
	</tr>
</table>
...
<table border="0">
	<tr>
		<td>發送會員編號:</td>
		<td><input type="TEXT" name="grpComment_MemId" size="45"
			value="<%= (grp_commentVO==null)? "1" : grp_commentVO.getGrpComment_MemId()%>" /></td>
	</tr>
	<tr>
		<td>揪團編號:</td>
		<td><input type="TEXT" name="grpComment_GrpId" size="45"
			value="<%= (grp_commentVO==null)? "1" : grp_commentVO.getGrpComment_GrpId()%>" /></td>
	</tr>
	<tr>
		<td>發送內容:</td>
