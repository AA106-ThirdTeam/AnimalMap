...
<%
    ...
    List<Second_ProdPhotosVO> list = second_prodphotosSvc.getAll();
    pageContext.setAttribute("list",list);
%>
<html>
<head>
<title>所有二手商品相簿資料 - listAllSecond_ProdPhotos.jsp</title>
	<!-- BS -->
...
<table class="table table-hover">
    <tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
        <td>
        <h3>所有二手商品相簿資料 - ListAllSecond_ProdPhotos.jsp</h3>
...
<table border='1' bordercolor='#CCCCFF' >
    ...
    <!-- END : include page1部分 -->
    <!-- 顯示查詢資料的部分 -->
    <c:forEach var="second_prodphotosVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
