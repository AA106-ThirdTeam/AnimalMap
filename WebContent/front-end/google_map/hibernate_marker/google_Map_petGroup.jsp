...
// 					    // 標記的位置
// 					    // Marker location
					    ,addr: ['<%=vo.getGrp_Long()%>', '<%=vo.getGrp_Lat()%>']
...
// 					    // 或是 Object 定義更詳細的圖示
			            ,'icon': {
			            	 // 圖示網址
			                'url': 'https://i.imgur.com/HwBCZ8T.png'
		                	// 縮放尺寸
...
<script type="text/javascript">
	function show_petGroup_details_page(pk_value) {
		...
		var src='<%=request.getContextPath()%>/Heibernate_front-end/marker_detail_infowindow/petGroup_detail_page.jsp?'+path_parameter 
