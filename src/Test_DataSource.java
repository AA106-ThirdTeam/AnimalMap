...
public class Test_DataSource extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			...
			DataSource ds = (DataSource) ctx.lookup("java:comp/env/jdbc/TestDB_dream");
			if (ds != null) {
				...
				if (conn != null) {
					...
					ResultSet rs = stmt.executeQuery("select * from vet_hospital");
					while (rs.next()) {
						out.println("hos_Id = " + rs.getString(1));
					}
					conn.close();
				}
			}
