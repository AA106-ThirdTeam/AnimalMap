...
<!-- 		<button type="button" id="AM_Friend" class="btn btn-primary">討論版</button> -->
        ...
        <a href="#" class="btn btn-danger btn-lg" onclick="switchAddBar();">
          ...
          <div class="container" id="addbar" style="background-color: rgba(38, 35, 35, 0); height:480px; width:40px; position:relative; padding-top:0px; padding-left:0px;padding-right:0px" hidden>
          	...
          	<div class="row" style="height:55px;"><img id="" ALT="" title="喜歡" src="<%=request.getContextPath()%>/front-end/homepage/imgs/map_adoptani_icon2.gif" width="50" height="50" padding-left="0" onclick="addObjectIntoMap(4)"> </div>
          	<div class="row" style="height:55px;"><img id="" ALT="新增揪團" title="新增揪團" src="<%=request.getContextPath()%>/front-end/homepage/imgs/dog-in-front-of-a-man.png" width="50" height="50" padding-left="0" onclick="addObjectIntoMap(5)"> </div>
