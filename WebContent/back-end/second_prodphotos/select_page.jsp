...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/second_prodphotos/listAllSecond_ProdPhotos.jsp'>List</a> all Second_ProdPhotoss. </li> <br><br>
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/second_prodphotos/second_prodphotos.do" name="form1">
...
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/second_prodphotos/addSecond_ProdPhotos.jsp'>Add</a> a new Second_ProdPhotos.</li>
</ul>
