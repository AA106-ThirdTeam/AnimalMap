...
<%
    ...
    List<Pet_groupVO> list = pet_groupSvc.getAll();
    pageContext.setAttribute("list",list);
%>
<html>
<head>
<title>所有揪團資料 - listAllPet_group.jsp</title>
	<!-- BS -->
...
<table class="table table-hover">
    <tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
        <td>
        <h3>所有揪團資料 - ListAllPet_group.jsp</h3>
...
<table border='1' bordercolor='#CCCCFF' >
    ...
    <!-- END : include page1部分 -->
    <!-- 顯示查詢資料的部分 -->
    <c:forEach var="pet_groupVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
