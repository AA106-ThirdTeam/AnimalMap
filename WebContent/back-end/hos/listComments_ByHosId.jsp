...
<head>
	...
	<title>醫院留言 - listComments_ByHosId.jsp</title>
</head>
<body bgcolor='white'>
...
<table border='1' cellpadding='5' cellspacing='0' width='800'>
	<tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
		<td>
		<h3>醫院留言 - listComments_ByHosId.jsp</h3>
		<a href="<%=request.getContextPath()%>/front-end/hos/select_page.jsp"><img src="images/back1.gif" width="100" height="32" border="0">回首頁</a>
		</td>
	</tr>
</table>
