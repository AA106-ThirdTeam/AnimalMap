...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/second_prod/listAllSecond_Prod.jsp'>List</a> all Second_Prods. </li> <br><br>
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/second_prod/second_prod.do" name="form1">
      <b><font color=blue>萬用複合查詢:</font></b> <br>
       ...
       <br> 
        ...
        >
            <img align="middle" border="0" name="BTN_date"  src="<%=request.getContextPath()%>/back-end/images/btn_date_up.gif" width="22" height="17" alt="二手商品發布時間">
        </a>
        <br>
        ...
        >
            <img align="middle" border="0" name="BTN_date"  src="<%=request.getContextPath()%>/back-end/images/btn_date_up.gif" width="22" height="17" alt="二手商品截止時間">
        </a>
        <br>
        ...
        >
            <img align="middle" border="0" name="BTN_date"  src="<%=request.getContextPath()%>/back-end/images/btn_date_up.gif" width="22" height="17" alt="二手商品更新時間">
        </a>
        <br>
...
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/second_prod/addSecond_Prod.jsp'>Add</a> a new Second_Prod.</li>
</ul>
