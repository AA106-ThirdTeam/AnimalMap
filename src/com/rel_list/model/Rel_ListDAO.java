...
import jdbc.util.CompositeQuery.jdbcUtil_CompositeQuery_Rel_List;
/** 
 *表格名稱 : <br>
 *	關係名單<br>
 *	英文:rel_List<br>
...
public class Rel_ListDAO implements Rel_ListDAO_interface{
	...
	//====以下是GET_ByFK_STMT指令====
    private static final String GET_Rel_Lists_ByMem_Id_STMT = 
		"SELECT rel_MemId,added_MemId,isBlackList,isInvited FROM Rel_List WHERE rel_MemId = ? order by rel_MemId";
    private static final String GET_Rel_Lists_ByMem_Id2_STMT = 
		"SELECT rel_MemId,added_MemId,isBlackList,isInvited FROM Rel_List WHERE added_MemId = ? order by added_MemId";
	...
	//====以下是改寫delete方法====
	@Override
	public void delete_By_added_MemId(String  aRel_List){
		Connection con = null;
		PreparedStatement pstmt = null;
		try {
			con = ds.getConnection();
	...
	@Override
	public Rel_ListVO findByPrimaryKey_By_rel_MemId(String  aPK_NO){
    ...
    public List<Rel_ListVO> getAll(Map<String, String[]> map) {
        ...
        try {
            ...
            con = ds.getConnection();
            String finalSQL = "select * from Rel_List "
                  + jdbcUtil_CompositeQuery_Rel_List.get_WhereCondition(map)
                  + "order by {PK英文名稱}";
            ...
            while (rs.next()) {
                ...
                list.add(rel_listVO); // Store the row in the List
            }
    ...
    public Set<Rel_ListVO> getRel_ListsByMem_Id(String rel_MemId) {
        Set<Rel_ListVO> set = new LinkedHashSet<Rel_ListVO>();
        Rel_ListVO rel_listVO = null;
        ...
        try {
            ...
            con = ds.getConnection();
            pstmt = con.prepareStatement(GET_Rel_Lists_ByMem_Id_STMT);
            ...
            while (rs.next()) {
                ...
                set.add(rel_listVO); // Store the row in the vector
            }
    ...
    public Set<Rel_ListVO> getRel_ListsByMem_Id2(String added_MemId) {
        ...
        try {
            ...
            con = ds.getConnection();
            pstmt = con.prepareStatement(GET_Rel_Lists_ByMem_Id2_STMT);
            pstmt.setString(1, added_MemId);
            rs = pstmt.executeQuery();
