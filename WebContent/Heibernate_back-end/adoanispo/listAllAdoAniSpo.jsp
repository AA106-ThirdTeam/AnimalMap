...
<%
    ...
    List<AdoAniSpoVO> list = adoanispoSvc.getAll();
    pageContext.setAttribute("list",list);
%>
<html>
<head>
<title>所有送養動物領養人資料 - listAllAdoAniSpo.jsp</title>
	<!-- BS -->
...
<table class="table table-hover">
    <tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
        <td>
        <h3>所有送養動物領養人資料 - ListAllAdoAniSpo.jsp</h3>
...
<table border='1' bordercolor='#CCCCFF' >
    <tr align='center' valign='middle'>
		<td><b>送養動物贊助編號</b></td>		<td><b>送養動物</b></td>		<td><b>贊助者會員</b></td>		<td><b>贊助送養動物金額</b></td>		<td><b>贊助送養動物物資</b></td>    
        <td><b>修改</b></td>
        <td><b>刪除</b></td>
    </tr>
    <!-- include page1部分 -->
    ...
    <!-- END : include page1部分 -->
    <!-- 顯示查詢資料的部分 -->
    <c:forEach var="adoanispoVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
	...
	<td>
		<font color=orange>${adoanispoVO.adopt_AniVO.adopt_Ani_Id}</font>
	</td>
	<td>
		<font color=orange>${adoanispoVO.memVO.mem_Id}</font>
	</td>
