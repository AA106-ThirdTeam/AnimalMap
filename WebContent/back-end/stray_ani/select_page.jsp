...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/stray_ani/listAllStray_Ani.jsp'>List</a> all Stray_Anis. </li> <br><br>
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/stray_ani/stray_ani.do" name="form1">
      <b><font color=blue>萬用複合查詢:</font></b> <br>
       ...
       <br> 
        ...
        >
            <img align="middle" border="0" name="BTN_date"  src="<%=request.getContextPath()%>/back-end/images/btn_date_up.gif" width="22" height="17" alt="流浪動物發現時間">
        </a>
        <br>
        ...
        >
            <img align="middle" border="0" name="BTN_date"  src="<%=request.getContextPath()%>/back-end/images/btn_date_up.gif" width="22" height="17" alt="流浪動物建立時間">
        </a>
        <br>
...
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/stray_ani/addStray_Ani.jsp'>Add</a> a new Stray_Ani.</li>
</ul>
