...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/Heibernate_back-end/adopt_ani_photos/listAllAdopt_Ani_photos.jsp'>List</a> all Adopt_Ani_photoss. </li> <br><br>
  <li>
  ...
  <jsp:useBean id="adopt_ani_photosSvc" scope="page" class="heibernate_com.adopt_ani_photos.model.Adopt_Ani_photosService" />
  <li>
     <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/Heibernate_back-end/adopt_ani_photos/adopt_ani_photos.do" >
       <b>選擇送養動物相簿編號:</b>
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/Heibernate_back-end/adopt_ani_photos/adopt_ani_photos.do" name="form1">
...
<h3>送養動物相簿管理</h3>
<ul>
  <li><a href='<%=request.getContextPath()%>/Heibernate_back-end/adopt_ani_photos/addAdopt_Ani_photos.jsp'>Add</a> a new Adopt_Ani_photos.</li>
</ul>
<!--  -->
	    <hr>
