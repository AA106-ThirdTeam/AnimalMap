...
public class HibernateUtil_CompositeQuery_AdpMsg {
	...
	public static List<AdpMsgVO> getAllC(Map<String, String[]> map) {
...
//		map.put("adpMsg_Id", new String[] { "7001" });	
//		map.put("adp_Id", new String[] { "7001" });	
//		map.put("mem_Id", new String[] { "7001" });	
//		map.put("msg", new String[] { "7001" });	
//		map.put("adpMsgDate", new String[] { "7001" });	
//		map.put("adpMsgadp_upDate", new String[] { "7001" });	

//		map.put("action", new String[] { "getXXX" }); //注意Map裡面會含有action的key
		List<AdpMsgVO> list = getAllC(map);
		for (AdpMsgVO aEmp : list) {
			//System.out.print(aEmp.getAdpMsg_Id() + ",");
			//System.out.print(aEmp.getAdp_Id() + ",");
			//System.out.print(aEmp.getMem_Id() + ",");
			//System.out.print(aEmp.getMsg() + ",");
			//System.out.print(aEmp.getAdpMsgDate() + ",");
			//System.out.print(aEmp.getAdpMsgadp_upDate() + ",");
			System.out.println();
		}
	}
}
