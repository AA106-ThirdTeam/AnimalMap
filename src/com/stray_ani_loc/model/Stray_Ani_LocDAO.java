...
import jdbc.util.CompositeQuery.jdbcUtil_CompositeQuery_Stray_Ani_Loc;
/** 
 *表格名稱 : <br>
 *	社區流浪動物出沒範圍<br>
 *	英文:stray_Ani_Loc<br>
...
public class Stray_Ani_LocDAO implements Stray_Ani_LocDAO_interface{
	...
	//====以下是GET_ByFK_STMT指令====
    private static final String GET_Stray_Ani_Locs_ByStray_Ani_Id_STMT = 
		"SELECT str_Ani_Loc_No,stray_Ani_Id,mem_Id,str_Ani_LocLat,str_Ani_LocLon FROM Stray_Ani_Loc WHERE stray_Ani_Id = ? order by stray_Ani_Id";
    private static final String GET_Stray_Ani_Locs_ByMem_Id_STMT = 
		"SELECT str_Ani_Loc_No,stray_Ani_Id,mem_Id,str_Ani_LocLat,str_Ani_LocLon FROM Stray_Ani_Loc WHERE mem_Id = ? order by mem_Id";
    ...
    public List<Stray_Ani_LocVO> getAll(Map<String, String[]> map) {
        ...
        try {
            ...
            con = ds.getConnection();
            String finalSQL = "select * from Stray_Ani_Loc "
                  + jdbcUtil_CompositeQuery_Stray_Ani_Loc.get_WhereCondition(map)
                  + "order by str_Ani_Loc_No";
            ...
            while (rs.next()) {
                ...
                list.add(stray_ani_locVO); // Store the row in the List
            }
    ...
    public Set<Stray_Ani_LocVO> getStray_Ani_LocsByStray_Ani_Id(String stray_Ani_Id) {
        Set<Stray_Ani_LocVO> set = new LinkedHashSet<Stray_Ani_LocVO>();
        Stray_Ani_LocVO stray_ani_locVO = null;
        ...
        try {
            ...
            con = ds.getConnection();
            pstmt = con.prepareStatement(GET_Stray_Ani_Locs_ByStray_Ani_Id_STMT);
            ...
            while (rs.next()) {
                ...
                set.add(stray_ani_locVO); // Store the row in the vector
            }
    ...
    public Set<Stray_Ani_LocVO> getStray_Ani_LocsByMem_Id(String mem_Id) {
        ...
        try {
            ...
            con = ds.getConnection();
            pstmt = con.prepareStatement(GET_Stray_Ani_Locs_ByMem_Id_STMT);
