...
<FORM METHOD="post" ACTION="grp_comment.do" name="form1">
    ...
    <tr>
        <td>發送會員編號:</td>
        <td><input type="TEXT" name="grpComment_MemId" size="45" value="<%=grp_commentVO.getGrpComment_MemId()%>" /></td>
    </tr>
	
    <tr>
        <td>揪團編號:</td>
        <td><input type="TEXT" name="grpComment_GrpId" size="45" value="<%=grp_commentVO.getGrpComment_GrpId()%>" /></td>
    </tr>
