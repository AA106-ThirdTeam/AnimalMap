...
import jdbc.util.CompositeQuery.jdbcUtil_CompositeQuery_Product_kind;
/** 
 *表格名稱 : <br>
 *	商品類別<br>
 *	英文:product_kind<br>
...
public class Product_kindDAO implements Product_kindDAO_interface{
    ...
    public List<Product_kindVO> getAll(Map<String, String[]> map) {
        ...
        try {
            ...
            con = ds.getConnection();
            String finalSQL = "select * from Product_kind "
                  + jdbcUtil_CompositeQuery_Product_kind.get_WhereCondition(map)
