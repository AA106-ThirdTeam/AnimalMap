...
<%
    ...
    List<Animal_indexVO> list = animal_indexSvc.getAll();
    pageContext.setAttribute("list",list);
%>
<html>
<head>
<title>所有動物圖鑑資料 - listAllAnimal_index.jsp</title>
	<!-- BS -->
...
<table class="table table-hover">
    <tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
        <td>
        <h3>所有動物圖鑑資料 - ListAllAnimal_index.jsp</h3>
...
<table border='1' bordercolor='#CCCCFF' >
    <tr align='center' valign='middle'>
		<td><b>圖鑑編號</b></td>		<td><b>圖鑑敘述</b></td>		<td><b>圖鑑類別</b></td>		<td><b>圖鑑類別照片編號</b></td>    
        <td><b>修改</b></td>
        <td><b>刪除</b></td>
    </tr>
    <!-- include page1部分 -->
    ...
    <!-- END : include page1部分 -->
    <!-- 顯示查詢資料的部分 -->
    <c:forEach var="animal_indexVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
