...
<%
    ...
    List<Hos_photoVO> list = hos_photoSvc.getAll();
    pageContext.setAttribute("list",list);
%>
<html>
<head>
<title>所有診所相片資料 - listAllHos_photo.jsp</title>
	<!-- BS -->
...
<table class="table table-hover">
    <tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
        <td>
        <h3>所有診所相片資料 - ListAllHos_photo.jsp</h3>
...
<table border='1' bordercolor='#CCCCFF' >
    ...
    <!-- END : include page1部分 -->
    <!-- 顯示查詢資料的部分 -->
    <c:forEach var="hos_photoVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
	...
	<td><img src="https://i.imgur.com/rv4YG8U.jpg" style="width:304px;height:228px;"></td>
			<td>${hos_photoVO.isDisp_HosPhoto}</td>
			<td>${hos_photoVO.hosPhoto_name}</td>
			<td>${hos_photoVO.HOSPHOTO_EXTENTION}</td>
            <!-- 修改按鈕部分 -->
            <td>
