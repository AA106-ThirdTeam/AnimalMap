...
<%
    ...
    List<Second_ProdMsgVO> list = second_prodmsgSvc.getAll();
    pageContext.setAttribute("list",list);
%>

<html>
<head>
<title>所有二手商品留言資料 - listAllSecond_ProdMsg.jsp</title>
</head>
<body bgcolor='white'>
...
<table border='1' cellpadding='5' cellspacing='0' >
    <tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
        <td>
        <h3>所有二手商品留言資料 - ListAllSecond_ProdMsg.jsp</h3>
...
<table border='1' bordercolor='#CCCCFF' >
    ...
    <!-- 顯示查詢資料的部分 -->
    <c:forEach var="second_prodmsgVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
