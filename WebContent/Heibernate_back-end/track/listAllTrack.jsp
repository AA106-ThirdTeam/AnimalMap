...
<%
    ...
    List<TrackVO> list = trackSvc.getAll();
    pageContext.setAttribute("list",list);
%>
<html>
<head>
<title>所有追蹤收藏資料 - listAllTrack.jsp</title>
	<!-- BS -->
...
<table class="table table-hover">
    <tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
        <td>
        <h3>所有追蹤收藏資料 - ListAllTrack.jsp</h3>
...
<table border='1' bordercolor='#CCCCFF' >
    <tr align='center' valign='middle'>
		<td><b>收藏編號</b></td>		<td><b>會員</b></td>		<td><b>收藏種類</b></td>		<td><b>種類編號</b></td>    
        <td><b>修改</b></td>
        <td><b>刪除</b></td>
    </tr>
    <!-- include page1部分 -->
    ...
    <!-- END : include page1部分 -->
    <!-- 顯示查詢資料的部分 -->
    <c:forEach var="trackVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
        <tr align='center' valign='middle' ${(trackVO.track_Id==param.track_Id) ? 'bgcolor=#CCCCFF':''}><!--將修改的那一筆加入對比色而已-->
			<td>${trackVO.track_Id}</td>
	<td>
		<font color=orange>${trackVO.memVO.mem_Id}</font>
	</td>
