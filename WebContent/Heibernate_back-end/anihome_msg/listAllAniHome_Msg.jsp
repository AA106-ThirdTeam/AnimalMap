...
<%
    ...
    List<AniHome_MsgVO> list = anihome_msgSvc.getAll();
    pageContext.setAttribute("list",list);
%>
<html>
<head>
<title>所有動物之家留言資料 - listAllAniHome_Msg.jsp</title>
	<!-- BS -->
...
<table class="table table-hover">
    <tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
        <td>
        <h3>所有動物之家留言資料 - ListAllAniHome_Msg.jsp</h3>
        <a href="<%=request.getContextPath()%>/Heibernate_back-end/anihome_msg/select_page.jsp">
...
<table border='1' bordercolor='#CCCCFF' >
    ...
    <!-- END : include page1部分 -->
    <!-- 顯示查詢資料的部分 -->
    <c:forEach var="anihome_msgVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
