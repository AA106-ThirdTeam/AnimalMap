...
<html>
<head>
<title>社區流浪動物新增 - addStray_Ani.jsp</title></head>
...
<table border='1' cellpadding='5' cellspacing='0' width='800'>
	<tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
		...
		<td>
		   <a href="<%=request.getContextPath()%>/stray_ani/select_page.jsp"><img src="<%=request.getContextPath()%>/images/tomcat.gif" width="100" height="100" border="1">回首頁</a>
	    </td>
	</tr>
</table>
...
<table border="0">
	<tr>
		...
		<td><input type="TEXT" name="mem_Id" size="45"
			value="<%= (stray_aniVO==null)? "1" : stray_aniVO.getMem_Id()%>" /></td>
	</tr>
	<tr>
		<td>流浪動物名字:</td>
	...
	<tr>
		...
		<td bgcolor="#CCCCFF">
		    ...
		    <img align="middle" border="0" name="BTN_date"	src="<%=request.getContextPath()%>/images/btn_date_up.gif" width="22" height="17" alt="流浪動物發現時間"></a>
		</td>
	</tr>
	<tr>
		<td>流浪動物物件狀態:</td>
	...
	<tr>
		...
		<td bgcolor="#CCCCFF">
		    ...
		    <img align="middle" border="0" name="BTN_date"	src="<%=request.getContextPath()%>/images/btn_date_up.gif" width="22" height="17" alt="流浪動物建立時間"></a>
		</td>
	</tr>
	<tr>
		<td>流浪出沒地點經度:</td>
