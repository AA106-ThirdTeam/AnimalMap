...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/Heibernate_back-end/product_kind/listAllProduct_kind.jsp'>List</a> all Product_kinds. </li> <br><br>
  <li>
  ...
  <jsp:useBean id="product_kindSvc" scope="page" class="heibernate_com.product_kind.model.Product_kindService" />
  <li>
     <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/Heibernate_back-end/product_kind/product_kind.do" >
       <b>選擇商品類別編號:</b>
...
<h3>商品類別管理</h3>
<ul>
  <li><a href='<%=request.getContextPath()%>/Heibernate_back-end/product_kind/addProduct_kind.jsp'>Add</a> a new Product_kind.</li>
</ul>
<!--  -->
<!--  -->
</body>
