...
<jsp:useBean id="listParks_ByCompositeQuery" scope="request" type="java.util.List" />
...
<html>
<head>
<title>複合查詢 - listParks_ByCompositeQuery.jsp</title>
	<!-- 共用HEAD -->
...
<table border='1' cellpadding='5' cellspacing='0' width='800'>
    <tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
        <td>
        <h3><font color=red>複合查詢</font>公園 - listParks_ByCompositeQuery.jsp</h3>
        <a href="<%=request.getContextPath()%>/back-end/park/select_page.jsp"><img src="<%=request.getContextPath()%>/back-end/images/back1.gif" width="100" height="32" border="0">回首頁</a>
        </td>
    </tr>
</table>
...
<%  
    rowNumber=listParks_ByCompositeQuery.size();
 ...
 <tr>
  <%if (rowsPerPage<rowNumber) {%>
    <%if(pageIndex>=rowsPerPage){%>
        <td><A href="<%=request.getContextPath()%>/park/park.do?whichPage=1&action=listParks_ByCompositeQuery">至第一頁</A>&nbsp;</td>
        <td><A href="<%=request.getContextPath()%>/park/park.do?whichPage=<%=whichPage-1%>&action=listParks_ByCompositeQuery">上一頁 </A>&nbsp;</td>
    <%}%>
  
    <%if(pageIndex<pageIndexArray[pageNumber-1]){%>
        <td><A href="<%=request.getContextPath()%>/park/park.do?whichPage=<%=whichPage+1%>&action=listParks_ByCompositeQuery">下一頁 </A>&nbsp;</td>
        <td><A href="<%=request.getContextPath()%>/park/park.do?whichPage=<%=pageNumber%>&action=listParks_ByCompositeQuery">至最後一頁</A>&nbsp;</td>
    <%}%>
  <%}%>  
 </tr>
</table>    
 ...
 <tr> 
   ...
   <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/park/park.do">   
        ...
        <%}%> 
           ...
           <input type="hidden" name="action"  value="listParks_ByCompositeQuery">  
        </td>
   </FORM>
 </tr>
</table>
