...
<%
    ...
    List<Emg_HelpVO> list = emg_helpSvc.getAll();
    pageContext.setAttribute("list",list);
%>
<html>
<head>
<title>所有緊急求救資料 - listAllEmg_Help.jsp</title>
	<!-- BS -->
...
<table class="table table-hover">
    <tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
        <td>
        <h3>所有緊急求救資料 - ListAllEmg_Help.jsp</h3>
...
<table border='1' bordercolor='#CCCCFF' >
    <tr align='center' valign='middle'>
		<td><b>求救編號</b></td>		<td><b>發起人</b></td>		<td><b>開始時間</b></td>		<td><b>結束日期</b></td>		<td><b>求救標題</b></td>		<td><b>求救內容</b></td>		<td><b>照片</b></td>		<td><b>照片副檔名</b></td>		<td><b>縣市</b></td>		<td><b>鄉鎮市區</b></td>		<td><b>道路街名村里</b></td>		<td><b>緊急求救經度座標</b></td>		<td><b>緊急求救緯度座標</b></td>		<td><b>檢舉狀態</b></td>    
        <td><b>修改</b></td>
        <td><b>刪除</b></td>
    </tr>
    <!-- include page1部分 -->
    ...
    <!-- END : include page1部分 -->
    <!-- 顯示查詢資料的部分 -->
    <c:forEach var="emg_helpVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
