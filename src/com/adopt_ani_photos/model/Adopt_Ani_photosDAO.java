...
import jdbc.util.CompositeQuery.jdbcUtil_CompositeQuery_Adopt_Ani_photos;
/** 
 *表格名稱 : <br>
 *	送養動物相簿<br>
...
public class Adopt_Ani_photosDAO implements Adopt_Ani_photosDAO_interface{
	...
	//====以下是GET_ByFK_STMT指令====
    private static final String GET_Adopt_Ani_photoss_ByAdopt_Ani_Id_STMT = 
		"SELECT ado_Ani_Pic_No,adopt_Ani_Id,mem_Id,ado_Ani_Pic,ado_Pic_name,ado_Pic_extent,to_char(ado_Pic_time,'yyyy-mm-dd') ado_Pic_time,ado_Pic_type FROM Adopt_Ani_photos WHERE adopt_Ani_Id = ? order by adopt_Ani_Id";
    private static final String GET_Adopt_Ani_photoss_ByMem_Id_STMT = 
		"SELECT ado_Ani_Pic_No,adopt_Ani_Id,mem_Id,ado_Ani_Pic,ado_Pic_name,ado_Pic_extent,to_char(ado_Pic_time,'yyyy-mm-dd') ado_Pic_time,ado_Pic_type FROM Adopt_Ani_photos WHERE mem_Id = ? order by mem_Id";
    ...
    public List<Adopt_Ani_photosVO> getAll(Map<String, String[]> map) {
        ...
        try {
            ...
            con = ds.getConnection();
            String finalSQL = "select * from Adopt_Ani_photos "
                  + jdbcUtil_CompositeQuery_Adopt_Ani_photos.get_WhereCondition(map)
                  + "order by ado_Ani_Pic_No";
            ...
            while (rs.next()) {
                ...
                list.add(adopt_ani_photosVO); // Store the row in the List
            }
    ...
    public Set<Adopt_Ani_photosVO> getAdopt_Ani_photossByAdopt_Ani_Id(String adopt_Ani_Id) {
        Set<Adopt_Ani_photosVO> set = new LinkedHashSet<Adopt_Ani_photosVO>();
        Adopt_Ani_photosVO adopt_ani_photosVO = null;
        ...
        try {
            ...
            con = ds.getConnection();
            pstmt = con.prepareStatement(GET_Adopt_Ani_photoss_ByAdopt_Ani_Id_STMT);
            ...
            while (rs.next()) {
                ...
                set.add(adopt_ani_photosVO); // Store the row in the vector
            }
    ...
    public Set<Adopt_Ani_photosVO> getAdopt_Ani_photossByMem_Id(String mem_Id) {
        ...
        try {
            ...
            con = ds.getConnection();
            pstmt = con.prepareStatement(GET_Adopt_Ani_photoss_ByMem_Id_STMT);
