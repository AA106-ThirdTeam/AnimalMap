...
<html>
<head>
	<title>表格 Adopt_Ani_sponsor: Home</title>
	<!-- 共用HEAD -->
	<!-- BS -->
...
<table class="table"  border='1' cellpadding='5' cellspacing='0' width='400'>
  <tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
    <td>
    <h3>表格 Adopt_Ani_sponsor: Home</h3><font color=red>( MVC )</font>
    </td>
  </tr>
</table>
<hr>
...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/Heibernate_back-end/adopt_ani_sponsor/listAllAdopt_Ani_sponsor.jsp'>List</a> all Adopt_Ani_sponsors. </li> <br><br>
  <li>
  ...
  <jsp:useBean id="adopt_ani_sponsorSvc" scope="page" class="heibernate_com.adopt_ani_sponsor.model.Adopt_Ani_sponsorService" />
  <li>
     <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/Heibernate_back-end/adopt_ani_sponsor/adopt_ani_sponsor.do" >
       <b>選擇送養動物贊助編號:</b>
  ...
  <li>
     <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/Heibernate_back-end/adopt_ani_sponsor/adopt_ani_sponsor.do" >
     	<div class="form-group">
	       ...
	       <input type="submit" value="送出">
	       <input type="hidden" name="action" value="listAdopt_Ani_sponsors_ByAdopt_Ani_Id_A">
       	</div>
     </FORM>
  </li>
  ...
  <li>
     <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/Heibernate_back-end/adopt_ani_sponsor/adopt_ani_sponsor.do" >
     	<div class="form-group">
	       ...
	       <input type="submit" value="送出">
	       <input type="hidden" name="action" value="listAdopt_Ani_sponsors_ByMem_Id_A">
       	</div>
     </FORM>
  </li>
</ul>
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/Heibernate_back-end/adopt_ani_sponsor/adopt_ani_sponsor.do" name="form1">
      <b><font color=blue>萬用複合查詢:</font></b> <br>
       ...
       <br> 
        <b>贊助送養動物時間:</b>
        <input class="cal-TextBox" onFocus="this.blur()" size="9" readonly type="text" name="ado_Ani_Spo_time" value="">
        ...
        >
            <img align="middle" border="0" name="BTN_date"  src="<%=request.getContextPath()%>/Heibernate_back-end/images/btn_date_up.gif" width="22" height="17" alt="贊助送養動物時間">
        </a>
        <br>
      <input type="submit" value="送出">
...
<h3>送養動物贊助管理</h3>
<ul>
  <li><a href='<%=request.getContextPath()%>/Heibernate_back-end/adopt_ani_sponsor/addAdopt_Ani_sponsor.jsp'>Add</a> a new Adopt_Ani_sponsor.</li>
</ul>
<!--  -->
	    <hr>
