...
<table border='1' cellpadding='5' cellspacing='0' width='800'>
	<tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
		...
		<td>
		   <a href="<%=request.getContextPath()%>/back-end/emg_h/select_page.jsp"><img src="<%=request.getContextPath()%>/images/tomcat.gif" width="100" height="100" border="1">回首頁</a>
	    </td>
	</tr>
</table>
...
<table border="0">
	...
	<tr>
		...
		<td><input type="TEXT" name="mem_Id" size="45"
			value="<%= (emg_hVO==null)? "1" : emg_hVO.getMem_Id()%>" /></td>
	</tr>	
