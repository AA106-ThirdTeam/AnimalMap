...
<%
    ...
    List<Priv_messageVO> list = priv_messageSvc.getAll();
    pageContext.setAttribute("list",list);
%>
<html>
<head>
<title>所有私人訊息資料 - listAllPriv_message.jsp</title>
	<!-- BS -->
...
<table class="table table-hover">
    <tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
        <td>
        <h3>所有私人訊息資料 - ListAllPriv_message.jsp</h3>
...
<table border='1' bordercolor='#CCCCFF' >
    ...
    <!-- END : include page1部分 -->
    <!-- 顯示查詢資料的部分 -->
    <c:forEach var="priv_messageVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
