...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/pet_message/listAllPet_Message.jsp'>List</a> all Pet_Messages. </li> <br><br>
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/pet_message/pet_message.do" name="form1">
...
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/pet_message/addPet_Message.jsp'>Add</a> a new Pet_Message.</li>
</ul>
...
<!--  -->
	    ...
	    <ul>
	      <li><a href='<%=request.getContextPath()%>/back-end/pet/listAllPet.jsp'>List</a> all Pets. </li>
	    </ul>
