...
<html>
<head>
	<title>表格 Adopt_Ani_photos: Home</title>
...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/adopt_ani_photos/listAllAdopt_Ani_photos.jsp'>List</a> all Adopt_Ani_photoss. </li> <br><br>
  ...
  <li>
     <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/adopt_ani_photos/adopt_ani_photos.do" >
     	<div class="form-group">
	       ...
	       <input type="submit" value="送出">
	       <input type="hidden" name="action" value="listAdopt_Ani_photoss_ByAdopt_Ani_Id_A">
       	</div>
     </FORM>
  </li>
  ...
  <li>
     <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/adopt_ani_photos/adopt_ani_photos.do" >
     	<div class="form-group">
	       ...
	       <input type="submit" value="送出">
	       <input type="hidden" name="action" value="listAdopt_Ani_photoss_ByMem_Id_A">
       	</div>
     </FORM>
  </li>
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/adopt_ani_photos/adopt_ani_photos.do" name="form1">
      <b><font color=blue>萬用複合查詢:</font></b> <br>
       ...
       <br> 
        ...
        <b>發布時間:</b>
        <input class="cal-TextBox" onFocus="this.blur()" size="9" readonly type="text" name="ado_Pic_time" value="">
        ...
        >
            <img align="middle" border="0" name="BTN_date"  src="<%=request.getContextPath()%>/back-end/images/btn_date_up.gif" width="22" height="17" alt="發布時間">
        </a>
        <br>
...
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/adopt_ani_photos/addAdopt_Ani_photos.jsp'>Add</a> a new Adopt_Ani_photos.</li>
</ul>
