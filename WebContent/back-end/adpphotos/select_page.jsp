...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/adpphotos/listAllAdpPhotos.jsp'>List</a> all AdpPhotoss. </li> <br><br>
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/adpphotos/adpphotos.do" name="form1">
...
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/adpphotos/addAdpPhotos.jsp'>Add</a> a new AdpPhotos.</li>
</ul>
