...
<%
    ...
    List<AniHome_PhotosVO> list = anihome_photosSvc.getAll();
    pageContext.setAttribute("list",list);
%>
<html>
<head>
<title>所有動物之家相簿資料 - listAllAniHome_Photos.jsp</title>
	<!-- BS -->
...
<table class="table table-hover">
    <tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
        <td>
        <h3>所有動物之家相簿資料 - ListAllAniHome_Photos.jsp</h3>
...
<table border='1' bordercolor='#CCCCFF' >
    <tr align='center' valign='middle'>
		<td><b>相片編號</b></td>		<td><b>動物之家</b></td>		<td><b>動物之家照片</b></td>    
        <td><b>修改</b></td>
        <td><b>刪除</b></td>
    </tr>
    <!-- include page1部分 -->
    ...
    <!-- END : include page1部分 -->
    <!-- 顯示查詢資料的部分 -->
    <c:forEach var="anihome_photosVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
