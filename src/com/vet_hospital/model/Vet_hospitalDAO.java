...
public class Vet_hospitalDAO implements Vet_hospitalDAO_interface{
	...
	//====以下是一般指令====
	public static final String INSERT_STMT = "INSERT INTO (hos_Id,mem_Id,hos_name,hos_city,hos_town,hos_road,hos_Eval,hos_URL,hos_StartTime,hos_EndTime,hos_Tel,hos_Desc,hos_Long,hos_Lat,hos_CreateTime,hos_visible ) VALUES  ( vet_hospital_seq1.nextval , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ?  )  " ; 
	//====以下是更新指令====
