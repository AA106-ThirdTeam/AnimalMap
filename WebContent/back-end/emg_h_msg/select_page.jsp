...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/emg_h_msg/listAllEmg_H_Msg.jsp'>List</a> all Emg_H_Msgs. </li> <br><br>
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/emg_h_msg/emg_h_msg.do" name="form1">
...
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/emg_h_msg/addEmg_H_Msg.jsp'>Add</a> a new Emg_H_Msg.</li>
</ul>
...
<!--  -->
	    ...
	    <ul>
	      <li><a href='<%=request.getContextPath()%>/back-end/emg_h/listAllEmg_H.jsp'>List</a> all Emg_Hs. </li>
	    </ul>
