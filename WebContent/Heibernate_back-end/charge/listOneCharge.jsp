...
<table border='1' bordercolor='#CCCCFF'>
    <tr align='center' valign='middle'>
		<td><b>儲值編號</b></td>		<td><b>會員</b></td>		<td><b>儲值金額</b></td>		<td><b>付款方式</b></td>		<td><b>儲值時間</b></td>
    </tr>
    <tr align='center' valign='middle'>    
			<td>${chargeVO.charge_no}</td>	
	<td>
		<font color=orange>${chargeVO.memVO.mem_Id}</font>
	</td>
			<td>${chargeVO.charge_NUMBER}</td>			<td>${chargeVO.pay}</td>			<td>${chargeVO.applytime}</td>
    </tr>
</table>
</body>
</html>        
