...
<%
    ...
    List<Adopt_Ani_photosVO> list = adopt_ani_photosSvc.getAll();
    pageContext.setAttribute("list",list);
%>
<html>
<head>
<title>所有送養動物相簿資料 - listAllAdopt_Ani_photos.jsp</title>
	<!-- BS -->
...
<table class="table table-hover">
    <tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
        <td>
        <h3>所有送養動物相簿資料 - ListAllAdopt_Ani_photos.jsp</h3>
...
<table border='1' bordercolor='#CCCCFF' >
    ...
    <!-- END : include page1部分 -->
    <!-- 顯示查詢資料的部分 -->
    <c:forEach var="adopt_ani_photosVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
	...
	<td><img src="https://i.imgur.com/rv4YG8U.jpg" style="width:304px;height:228px;"></td>
			...
			<td>${adopt_ani_photosVO.ado_Pic_nameEX}</td>
