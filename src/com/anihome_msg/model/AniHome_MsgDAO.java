...
import jdbc.util.CompositeQuery.jdbcUtil_CompositeQuery_AniHome_Msg;
/** 
 *表格名稱 : <br>
 *	動物之家留言<br>
 *	英文:aniHome_Msg<br>
...
public class AniHome_MsgDAO implements AniHome_MsgDAO_interface{
	...
	//====以下是GET_ByFK_STMT指令====
    private static final String GET_AniHome_Msgs_ByAniHome_Id_STMT = 
		"SELECT aniHome_Msg_Id,aniHome_Id,mem_Id,aniHome_Msg,to_char(adp_start_date,'yyyy-mm-dd') adp_start_date FROM AniHome_Msg WHERE aniHome_Id = ? order by aniHome_Id";
    private static final String GET_AniHome_Msgs_ByMem_Id_STMT = 
		"SELECT aniHome_Msg_Id,aniHome_Id,mem_Id,aniHome_Msg,to_char(adp_start_date,'yyyy-mm-dd') adp_start_date FROM AniHome_Msg WHERE mem_Id = ? order by mem_Id";
    ...
    public List<AniHome_MsgVO> getAll(Map<String, String[]> map) {
        ...
        try {
            ...
            con = ds.getConnection();
            String finalSQL = "select * from AniHome_Msg "
                  + jdbcUtil_CompositeQuery_AniHome_Msg.get_WhereCondition(map)
                  + "order by aniHome_Msg_Id";
            ...
            while (rs.next()) {
                ...
                list.add(anihome_msgVO); // Store the row in the List
            }
    ...
    public Set<AniHome_MsgVO> getAniHome_MsgsByAniHome_Id(String aniHome_Id) {
        Set<AniHome_MsgVO> set = new LinkedHashSet<AniHome_MsgVO>();
        AniHome_MsgVO anihome_msgVO = null;
        ...
        try {
            ...
            con = ds.getConnection();
            pstmt = con.prepareStatement(GET_AniHome_Msgs_ByAniHome_Id_STMT);
            ...
            while (rs.next()) {
                ...
                set.add(anihome_msgVO); // Store the row in the vector
            }
    ...
    public Set<AniHome_MsgVO> getAniHome_MsgsByMem_Id(String mem_Id) {
        ...
        try {
            ...
            con = ds.getConnection();
            pstmt = con.prepareStatement(GET_AniHome_Msgs_ByMem_Id_STMT);
