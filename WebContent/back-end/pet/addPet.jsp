...
<table border='1' cellpadding='5' cellspacing='0' width='800'>
	<tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
		...
		<td>
		   <a href="<%=request.getContextPath()%>/back-end/pet/select_page.jsp"><img src="<%=request.getContextPath()%>/images/tomcat.gif" width="100" height="100" border="1">回首頁</a>
	    </td>
	</tr>
</table>
...
<table border="0">
	...
	<tr>
		...
		<td bgcolor="#CCCCFF">
		    ...
		    <img align="middle" border="0" name="BTN_date"	src="/Excel2MVC/back-end/images/btn_date_up.gif" width="22" height="17" alt="寵物生日"></a>
		</td>
	</tr>
	...
	<tr>
		...
		<td bgcolor="#CCCCFF">
		    ...
		    <img align="middle" border="0" name="BTN_date"	src="/Excel2MVC/back-end/images/btn_date_up.gif" width="22" height="17" alt="寵物建立時間"></a>
		</td>
	</tr>
