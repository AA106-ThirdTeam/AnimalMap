...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/shopphoto/listAllShopPhoto.jsp'>List</a> all ShopPhotos. </li> <br><br>
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/shopphoto/shopphoto.do" name="form1">
...
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/shopphoto/addShopPhoto.jsp'>Add</a> a new ShopPhoto.</li>
</ul>
