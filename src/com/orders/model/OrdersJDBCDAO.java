...
//	String url = "jdbc:oracle:thin:@localhost:1521:XE";
	...
	private static final String DELETE_Orders_items =
			"DELETE FROM orders_item where order_no=?";
	...
	private static final String GET_Orders_items_ByOrders_no_STMT = 
			"SELECT order_no,product_no,commodities_amount,selling_price FROM orders_item where orders_no = ? order by orders_no";
...
//		orders_itemAA.setOrders_no("111");
		...
		orders_itemAA.setCommodities_amonut(1);
