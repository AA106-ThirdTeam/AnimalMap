...
public class Vet_hospitalVO implements java.io.Serializable{
	...
	*	限制條件:NOT NULL (FK)<br>
 	*/ 
	public	void setHos_MemId(String aHos_MemId) { 
		this.hos_MemId = aHos_MemId; 
	} 
	...
	*	限制條件:<br>
 	*/ 
	public	void setHos_StartTime(String aHos_StartTime) { 
	...
	*	限制條件:<br>
 	*/ 
	public	void setHos_EndTime(String aHos_EndTime) { 
