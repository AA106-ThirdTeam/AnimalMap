...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/offimsg/listAllOffiMsg.jsp'>List</a> all OffiMsgs. </li> <br><br>
    ...
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/offimsg/offimsg.do" name="form1">
      <b><font color=blue>萬用複合查詢:</font></b> <br>
       ...
       <br> 
        ...
        >
            <img align="middle" border="0" name="BTN_date"  src="<%=request.getContextPath()%>/back-end/images/btn_date_up.gif" width="22" height="17" alt="訊息發布時間">
        </a>
        <br>
...
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/offimsg/addOffiMsg.jsp'>Add</a> a new OffiMsg.</li>
</ul>
