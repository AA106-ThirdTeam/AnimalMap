...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/joinlist/listAllJoinList.jsp'>List</a> all JoinLists. </li> <br><br>
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/joinlist/joinlist.do" name="form1">
...
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/joinlist/addJoinList.jsp'>Add</a> a new JoinList.</li>
</ul>
