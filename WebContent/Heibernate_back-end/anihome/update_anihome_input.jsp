...
<font color=orange>${memVO.mem_name}</font>-<font color=black>${memVO.mem_nick_name}</font>				
	...
	<tr>
		...
		<td bgcolor="#CCCCFF">
		    ...
		    <img align="middle" border="0" name="BTN_date"	src="<%=request.getContextPath()%>/Heibernate_back-end/images/btn_date_up.gif" width="22" height="17" alt="動物之家發布時間"></a>
		</td>
	</tr>
	<tr>
		<td>動物之家更新時間:</td>
		<td bgcolor="#CCCCFF">
		    ...
		    <img align="middle" border="0" name="BTN_date"	src="<%=request.getContextPath()%>/Heibernate_back-end/images/btn_date_up.gif" width="22" height="17" alt="動物之家更新時間"></a>
		</td>
	</tr>
    <tr>
        <td>縣市:</td>
