...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/Heibernate_back-end/emp_purview/listAllEmp_purview.jsp'>List</a> all Emp_purviews. </li> <br><br>
  <li>
  ...
  <jsp:useBean id="emp_purviewSvc" scope="page" class="heibernate_com.emp_purview.model.Emp_purviewService" />
  <li>
     <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/Heibernate_back-end/emp_purview/emp_purview.do" >
       <b>選擇員工權限編號:</b>
...
<h3>員工權限管理</h3>
<ul>
  <li><a href='<%=request.getContextPath()%>/Heibernate_back-end/emp_purview/addEmp_purview.jsp'>Add</a> a new Emp_purview.</li>
</ul>
<!--  -->
	    <hr>
	    ...
	    <ul>
	      <li><a href='<%=request.getContextPath()%>/Heibernate_back-end/purview/listAllPurview.jsp'>List</a> all Purviews. </li>
	    </ul>
<!--  -->
</body>
</html>
