...
public class Emg_H_MsgVO implements java.io.Serializable {
	...
	private Timestamp emg_H_Msg_start;
	...
	public Timestamp getEmg_H_Msg_start() {
		return emg_H_Msg_start;
	}
	public void setEmg_H_Msg_start(Timestamp emg_H_Msg_start) {
		this.emg_H_Msg_start = emg_H_Msg_start;
	}
	public String getEmg_H_Msg_content() {
		return emg_H_Msg_content;
	}
