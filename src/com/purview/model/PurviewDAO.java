...
import jdbc.util.CompositeQuery.jdbcUtil_CompositeQuery_Purview;
/** 
 *表格名稱 : <br>
 *	權限<br>
 *	英文:purview<br>
...
public class PurviewDAO implements PurviewDAO_interface{
    ...
    public List<PurviewVO> getAll(Map<String, String[]> map) {
        ...
        try {
            ...
            con = ds.getConnection();
            String finalSQL = "select * from Purview "
                  + jdbcUtil_CompositeQuery_Purview.get_WhereCondition(map)
                  + "order by purview_No";
            ...
            while (rs.next()) {
                ...
                list.add(purviewVO); // Store the row in the List
            }
