...
<jsp:useBean id="listEmg_Hs_ByMem_Id" scope="request" type="java.util.Set" />

<html>
<head>
<title>發起人編號 - listEmg_Hs_ByMem_Id.jsp</title>
	<!-- 共用HEAD -->
...
<table border='1' cellpadding='5' cellspacing='0' width='800'>
    <tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
        <td>
        <h3>發起人編號 - listEmg_Hs_ByMem_Id.jsp</h3>
        <a href="<%=request.getContextPath()%>/back-end/emg_h/select_page.jsp"><img src="<%=request.getContextPath()%>/back-end/images/tomcat.gif" width="100" height="32" border="0">回首頁</a>
        </td>
    </tr>
</table>
...
<table border='1' bordercolor='#CCCCFF' width='800'>
    ...
    <c:forEach var="emg_hVO" items="${listEmg_Hs_ByMem_Id}" >    
        <tr>
