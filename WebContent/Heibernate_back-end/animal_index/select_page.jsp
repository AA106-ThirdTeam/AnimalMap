...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/Heibernate_back-end/animal_index/listAllAnimal_index.jsp'>List</a> all Animal_indexs. </li> <br><br>
  <li>
  ...
  <jsp:useBean id="animal_indexSvc" scope="page" class="heibernate_com.animal_index.model.Animal_indexService" />
  <li>
     <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/Heibernate_back-end/animal_index/animal_index.do" >
       <b>選擇動物圖鑑編號:</b>
...
<h3>動物圖鑑管理</h3>
<ul>
  <li><a href='<%=request.getContextPath()%>/Heibernate_back-end/animal_index/addAnimal_index.jsp'>Add</a> a new Animal_index.</li>
</ul>
<!--  -->
<!--  -->
</body>
