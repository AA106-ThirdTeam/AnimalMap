...
<html>
<head>
<title>社區流浪動物留言資料修改 - update_stray_ani_message_input.jsp</title></head>
...
<FORM METHOD="post" ACTION="stray_ani_message.do" name="form1">
    ...
    <tr>
        <td>社區動物編號:</td>
        <td><input type="TEXT" name="stray_Ani_Id" size="45" value="<%=stray_ani_messageVO.getStray_Ani_Id()%>" /></td>
    </tr>
    <tr>
        <td>發布者會員編號:</td>
        <td><input type="TEXT" name="mem_Id" size="45" value="<%=stray_ani_messageVO.getMem_Id()%>" /></td>
    </tr>
	<tr>
		<td>發布時間:</td>
		<td bgcolor="#CCCCFF">
