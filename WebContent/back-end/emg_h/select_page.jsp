...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/emg_h/listAllEmg_H.jsp'>List</a> all Emg_Hs. </li> <br><br>
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/emg_h/emg_h.do" name="form1">
...
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/emg_h/addEmg_H.jsp'>Add</a> a new Emg_H.</li>
</ul>
