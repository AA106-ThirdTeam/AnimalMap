...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/Heibernate_back-end/rel_list/listAllRel_List.jsp'>List</a> all Rel_Lists. </li> <br><br>
  <li>
  ...
  <jsp:useBean id="rel_listSvc" scope="page" class="heibernate_com.rel_list.model.Rel_ListService" />
  <li>
     <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/Heibernate_back-end/rel_list/rel_list.do" >
       <b>選擇關係名單編號:</b>
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/Heibernate_back-end/rel_list/rel_list.do" name="form1">
...
<h3>關係名單管理</h3>
<ul>
  <li><a href='<%=request.getContextPath()%>/Heibernate_back-end/rel_list/addRel_List.jsp'>Add</a> a new Rel_List.</li>
</ul>
<!--  -->
	    <hr>
