...
<jsp:useBean id="listEmg_H_Msgs_ByEmg_H_Id" scope="request" type="java.util.Set" />

<html>
<head>
<title>求救編號 - listEmg_H_Msgs_ByEmg_H_Id.jsp</title>
	<!-- 共用HEAD -->
...
<table border='1' cellpadding='5' cellspacing='0' width='800'>
    <tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
        <td>
        <h3>求救編號 - listEmg_H_Msgs_ByEmg_H_Id.jsp</h3>
...
<table border='1' bordercolor='#CCCCFF' width='800'>
    ...
    <c:forEach var="emg_h_msgVO" items="${listEmg_H_Msgs_ByEmg_H_Id}" >    
        <tr>
