...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/shop_comment/listAllShop_comment.jsp'>List</a> all Shop_comments. </li> <br><br>
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/shop_comment/shop_comment.do" name="form1">
...
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/shop_comment/addShop_comment.jsp'>Add</a> a new Shop_comment.</li>
</ul>
...
<!--  -->
	    ...
	    <ul>
	      <li><a href='<%=request.getContextPath()%>/back-end/petshop/listAllPetShop.jsp'>List</a> all PetShops. </li>
	    </ul>
