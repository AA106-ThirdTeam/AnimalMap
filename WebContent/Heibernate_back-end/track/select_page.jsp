...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/Heibernate_back-end/track/listAllTrack.jsp'>List</a> all Tracks. </li> <br><br>
  <li>
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/Heibernate_back-end/track/track.do" name="form1">
...
<h3>追蹤收藏管理</h3>
<ul>
  <li><a href='<%=request.getContextPath()%>/Heibernate_back-end/track/addTrack.jsp'>Add</a> a new Track.</li>
</ul>
<!--  -->
	    <hr>
