...
import jdbc.util.CompositeQuery.jdbcUtil_CompositeQuery_Stray_Ani;
/** 
 *表格名稱 : <br>
 *	社區流浪動物<br>
 *	英文:stray_Ani<br>
...
public class Stray_AniDAO implements Stray_AniDAO_interface{
	...
	//====以下是GET_ByFK_STMT指令====
    private static final String GET_Stray_Anis_ByMem_Id_STMT = 
		"SELECT stray_Ani_Id,mem_Id,stray_Ani_name,stray_Ani_type,stray_Ani_gender,stray_Ani_heal,stray_Ani_Vac,stray_Ani_color,stray_Ani_body,stray_Ani_age,stray_Ani_Neu,stray_Ani_chip,to_char(stray_Ani_date,'yyyy-mm-dd') stray_Ani_date,stray_Ani_status,to_char(stray_Ani_CreDate,'yyyy-mm-dd') stray_Ani_CreDate,stray_Ani_FinLat,stray_Ani_FinLon,stray_Ani_city,stray_Ani_town,stray_Ani_road FROM Stray_Ani WHERE mem_Id = ? order by mem_Id";
    ...
    public List<Stray_AniVO> getAll(Map<String, String[]> map) {
        ...
        try {
            ...
            con = ds.getConnection();
            String finalSQL = "select * from Stray_Ani "
                  + jdbcUtil_CompositeQuery_Stray_Ani.get_WhereCondition(map)
                  + "order by stray_Ani_Id";
            ...
            while (rs.next()) {
                ...
                list.add(stray_aniVO); // Store the row in the List
            }
    ...
    public Set<Stray_AniVO> getStray_AnisByMem_Id(String mem_Id) {
        Set<Stray_AniVO> set = new LinkedHashSet<Stray_AniVO>();
        Stray_AniVO stray_aniVO = null;
        ...
        try {
            ...
            con = ds.getConnection();
            pstmt = con.prepareStatement(GET_Stray_Anis_ByMem_Id_STMT);
            ...
            while (rs.next()) {
                ...
                set.add(stray_aniVO); // Store the row in the vector
            }
