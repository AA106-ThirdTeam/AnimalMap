...
<table border='1' bordercolor='#CCCCFF' >
    <tr align='center' valign='middle'>
		<td><b>寵物留言編號</b></td>		<td><b>寵物</b></td>		<td><b>發布者會員</b></td>		<td><b>寵物留言</b></td>		<td><b>發布時間</b></td>    
        <td><b>修改</b></td>
        <td><b>刪除</b></td>
    </tr>
    <!-- include page1部分 -->
	...
	<td>
		<font color=orange>${pet_messageVO.petVO.pet_Id}</font>
	</td>
	<td>
		<font color=orange>${pet_messageVO.memVO.mem_Id}</font>
	</td>
