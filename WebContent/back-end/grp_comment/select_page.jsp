...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/grp_comment/listAllGrp_comment.jsp'>List</a> all Grp_comments. </li> <br><br>
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/grp_comment/grp_comment.do" name="form1">
...
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/grp_comment/addGrp_comment.jsp'>Add</a> a new Grp_comment.</li>
</ul>
...
<!--  -->
	    ...
	    <ul>
	      <li><a href='<%=request.getContextPath()%>/back-end/pet_group/listAllPet_group.jsp'>List</a> all Pet_groups. </li>
	    </ul>
