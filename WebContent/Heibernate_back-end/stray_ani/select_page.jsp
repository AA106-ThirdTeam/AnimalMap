...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/Heibernate_back-end/stray_ani/listAllStray_Ani.jsp'>List</a> all Stray_Anis. </li> <br><br>
  <li>
  ...
  <li>
     <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/Heibernate_back-end/stray_ani/stray_ani.do" >
     	<div class="form-group">
	       ...
	       <input type="submit" value="送出">
	       <input type="hidden" name="action" value="listStray_Anis_ByMem_Id_A">
       	</div>
     </FORM>
  </li>
</ul>
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/Heibernate_back-end/stray_ani/stray_ani.do" name="form1">
      <b><font color=blue>萬用複合查詢:</font></b> <br>
       ...
       <br> 
        <b>流浪動物發現時間:</b>
        <input class="cal-TextBox" onFocus="this.blur()" size="9" readonly type="text" name="stray_Ani_date" value="">
        ...
        >
            <img align="middle" border="0" name="BTN_date"  src="<%=request.getContextPath()%>/Heibernate_back-end/images/btn_date_up.gif" width="22" height="17" alt="流浪動物發現時間">
        </a>
        <br>
        <b>流浪動物建立時間:</b>
        <input class="cal-TextBox" onFocus="this.blur()" size="9" readonly type="text" name="stray_Ani_CreDate" value="">
        <a class="so-BtnLink" href="javascript:calClick();return false;" 
        	onmouseover="calSwapImg('BTN_date', 'img_Date_OVER',true);" 
        	onmouseout="calSwapImg('BTN_date', 'img_Date_UP',true);" 
        	onclick="calSwapImg('BTN_date', 'img_Date_DOWN');showCalendar('form1','stray_Ani_CreDate','BTN_date');return false;"
        >
            <img align="middle" border="0" name="BTN_date"  src="<%=request.getContextPath()%>/Heibernate_back-end/images/btn_date_up.gif" width="22" height="17" alt="流浪動物建立時間">
        </a>
        <br>
      <input type="submit" value="送出">
...
<h3>社區流浪動物管理</h3>
<ul>
  <li><a href='<%=request.getContextPath()%>/Heibernate_back-end/stray_ani/addStray_Ani.jsp'>Add</a> a new Stray_Ani.</li>
</ul>
<!--  -->
	    <hr>
