...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/emg_help/listAllEmg_help.jsp'>List</a> all Emg_helps. </li> <br><br>
  ...
  <jsp:useBean id="emg_helpSvc" scope="page" class="com.emg_help.model.Emg_helpService" />
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/emg_help/emg_help.do" name="form1">
      <b><font color=blue>萬用複合查詢:</font></b> <br>
       ...
       <br> 
        ...
        >
            <img align="middle" border="0" name="BTN_date"  src="<%=request.getContextPath()%>/back-end/images/btn_date_up.gif" width="22" height="17" alt="開始時間">
        </a>
        <br>
        ...
        >
            <img align="middle" border="0" name="BTN_date"  src="<%=request.getContextPath()%>/back-end/images/btn_date_up.gif" width="22" height="17" alt="結束日期">
        </a>
        <br>
...
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/emg_help/addEmg_help.jsp'>Add</a> a new Emg_help.</li>
</ul>
