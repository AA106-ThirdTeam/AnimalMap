...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/orders_item/listAllOrders_item.jsp'>List</a> all Orders_items. </li> <br><br>
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/orders_item/orders_item.do" name="form1">
...
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/orders_item/addOrders_item.jsp'>Add</a> a new Orders_item.</li>
</ul>
...
<!--  -->
	    ...
	    <ul>
	      <li><a href='<%=request.getContextPath()%>/back-end/orders/listAllOrders.jsp'>List</a> all Orderss. </li>
	    </ul>
	    ...
	    <ul>
	      <li><a href='<%=request.getContextPath()%>/back-end/product/listAllProduct.jsp'>List</a> all Products. </li>
	    </ul>
