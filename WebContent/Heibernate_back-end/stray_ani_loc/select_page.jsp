...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/Heibernate_back-end/stray_ani_loc/listAllStray_Ani_Loc.jsp'>List</a> all Stray_Ani_Locs. </li> <br><br>
  <li>
  ...
  <jsp:useBean id="stray_ani_locSvc" scope="page" class="heibernate_com.stray_ani_loc.model.Stray_Ani_LocService" />
  <li>
     <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/Heibernate_back-end/stray_ani_loc/stray_ani_loc.do" >
       <b>選擇社區流浪動物出沒範圍編號:</b>
...
<h3>社區流浪動物出沒範圍管理</h3>
<ul>
  <li><a href='<%=request.getContextPath()%>/Heibernate_back-end/stray_ani_loc/addStray_Ani_Loc.jsp'>Add</a> a new Stray_Ani_Loc.</li>
</ul>
<!--  -->
	    <hr>
