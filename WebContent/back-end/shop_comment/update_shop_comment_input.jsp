...
<FORM METHOD="post" ACTION="shop_comment.do" name="form1">
    ...
    <tr>
        <td>發送會員編號:</td>
        <td><input type="TEXT" name="shopComment_MemId" size="45" value="<%=shop_commentVO.getShopComment_MemId()%>" /></td>
    </tr>
	
    <tr>
        <td>商店編號:</td>
        <td><input type="TEXT" name="shopComment_ShopId" size="45" value="<%=shop_commentVO.getShopComment_ShopId()%>" /></td>
    </tr>
	...
	<tr>
		...
		<td bgcolor="#CCCCFF">
		    ...
		    <img align="middle" border="0" name="BTN_date"	src="<%=request.getContextPath()%>/back-end/images/btn_date_up.gif" width="22" height="17" alt="發送時間"></a>
		</td>
	</tr>
