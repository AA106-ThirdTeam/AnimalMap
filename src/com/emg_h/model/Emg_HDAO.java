...
import jdbc.util.CompositeQuery.jdbcUtil_CompositeQuery_Emg_H;
/** 
 *表格名稱 : <br>
 *	緊急求救<br>
 *	英文:emg_H<br>
...
public class Emg_HDAO implements Emg_HDAO_interface{
	...
	//====以下是GET_ByFK_STMT指令====
    private static final String GET_Emg_Hs_ByMem_Id_STMT = 
		"SELECT emg_H_Id,mem_Id,to_char(emg_H_start_date,'yyyy-mm-dd') emg_H_start_date,to_char(emg_H_end_date,'yyyy-mm-dd') emg_H_end_date,emg_H_title,emg_H_content,emg_H_Pic,emg_H_Pic_format,emg_H_city,emg_H_town,emg_H_road,emg_H_Lon,emg_H_Lat FROM Emg_H WHERE mem_Id = ? order by mem_Id";
    ...
    public List<Emg_HVO> getAll(Map<String, String[]> map) {
        ...
        try {
            ...
            con = ds.getConnection();
            String finalSQL = "select * from Emg_H "
                  + jdbcUtil_CompositeQuery_Emg_H.get_WhereCondition(map)
                  + "order by emg_H_Id";
            ...
            while (rs.next()) {
                ...
                list.add(emg_hVO); // Store the row in the List
            }
    ...
    public Set<Emg_HVO> getEmg_HsByMem_Id(String mem_Id) {
        Set<Emg_HVO> set = new LinkedHashSet<Emg_HVO>();
        Emg_HVO emg_hVO = null;
        ...
        try {
            ...
            con = ds.getConnection();
            pstmt = con.prepareStatement(GET_Emg_Hs_ByMem_Id_STMT);
            ...
            while (rs.next()) {
                ...
                set.add(emg_hVO); // Store the row in the vector
            }
