...
import jdbc.util.CompositeQuery.jdbcUtil_CompositeQuery_Emg_H_Msg;
/** 
 *表格名稱 : <br>
 *	緊急求救留言<br>
 *	英文:emg_H_Msg<br>
...
public class Emg_H_MsgDAO implements Emg_H_MsgDAO_interface{
	...
	//====以下是GET_ByFK_STMT指令====
    private static final String GET_Emg_H_Msgs_ByMem_Id_STMT = 
		"SELECT emg_H_Msg_Id,mem_Id,emg_H_Id,to_char(emg_H_Msg_start,'yyyy-mm-dd') emg_H_Msg_start,emg_H_Msg_content FROM Emg_H_Msg WHERE mem_Id = ? order by mem_Id";
    private static final String GET_Emg_H_Msgs_ByEmg_H_Id_STMT = 
		"SELECT emg_H_Msg_Id,mem_Id,emg_H_Id,to_char(emg_H_Msg_start,'yyyy-mm-dd') emg_H_Msg_start,emg_H_Msg_content FROM Emg_H_Msg WHERE emg_H_Id = ? order by emg_H_Id";
    ...
    public List<Emg_H_MsgVO> getAll(Map<String, String[]> map) {
        ...
        try {
            ...
            con = ds.getConnection();
            String finalSQL = "select * from Emg_H_Msg "
                  + jdbcUtil_CompositeQuery_Emg_H_Msg.get_WhereCondition(map)
                  + "order by emg_H_Msg_Id";
            ...
            while (rs.next()) {
                ...
                list.add(emg_h_msgVO); // Store the row in the List
            }
    ...
    public Set<Emg_H_MsgVO> getEmg_H_MsgsByMem_Id(String mem_Id) {
        ...
        try {
            ...
            con = ds.getConnection();
            pstmt = con.prepareStatement(GET_Emg_H_Msgs_ByMem_Id_STMT);
    ...
    public Set<Emg_H_MsgVO> getEmg_H_MsgsByEmg_H_Id(String emg_H_Id) {
        ...
        try {
            ...
            con = ds.getConnection();
            pstmt = con.prepareStatement(GET_Emg_H_Msgs_ByEmg_H_Id_STMT);
