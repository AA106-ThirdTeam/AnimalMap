...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/res_ponse/listAllRes_ponse.jsp'>List</a> all Res_ponses. </li> <br><br>
  ...
  <li>
     <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/res_ponse/res_ponse.do" >
     	<div class="form-group">
	       ...
	       <input type="submit" value="送出">
	       <input type="hidden" name="action" value="listRes_ponses_ByMem_Id_A">
       	</div>
     </FORM>
  </li>
  ...
  <li>
     <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/res_ponse/res_ponse.do" >
     	<div class="form-group">
	       ...
	       <input type="submit" value="送出">
	       <input type="hidden" name="action" value="listRes_ponses_ByPost_Id_A">
       	</div>
     </FORM>
  </li>
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/res_ponse/res_ponse.do" name="form1">
      <b><font color=blue>萬用複合查詢:</font></b> <br>
       ...
       <br> 
        ...
        <b>修改時間:</b>
        <input class="cal-TextBox" onFocus="this.blur()" size="9" readonly type="text" name="res_ponse_upDate" value="">
        <a class="so-BtnLink" href="javascript:calClick();return false;" 
        	onmouseover="calSwapImg('BTN_date', 'img_Date_OVER',true);" 
        	onmouseout="calSwapImg('BTN_date', 'img_Date_UP',true);" 
...
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/res_ponse/addRes_ponse.jsp'>Add</a> a new Res_ponse.</li>
</ul>
...
<!--  -->
	    ...
	    <ul>
	      <li><a href='<%=request.getContextPath()%>/back-end/post/listAllPost.jsp'>List</a> all Posts. </li>
	    </ul>
