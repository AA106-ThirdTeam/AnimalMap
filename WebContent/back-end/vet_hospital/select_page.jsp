...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/vet_hospital/listAllVet_hospital.jsp'>List</a> all Vet_hospitals. </li> <br><br>
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/vet_hospital/vet_hospital.do" name="form1">
...
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/vet_hospital/addVet_hospital.jsp'>Add</a> a new Vet_hospital.</li>
</ul>
