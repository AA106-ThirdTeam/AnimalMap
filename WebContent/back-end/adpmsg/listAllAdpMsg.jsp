...
<%
    ...
    List<AdpMsgVO> list = adpmsgSvc.getAll();
    pageContext.setAttribute("list",list);
%>

<html>
<head>
<title>所有領養活動留言資料 - listAllAdpMsg.jsp</title>
	<!-- BS -->
...
<table class="table table-hover">
    <tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
        <td>
        <h3>所有領養活動留言資料 - ListAllAdpMsg.jsp</h3>
...
<table border='1' bordercolor='#CCCCFF' >
    ...
    <!-- 顯示查詢資料的部分 -->
    <c:forEach var="adpmsgVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
