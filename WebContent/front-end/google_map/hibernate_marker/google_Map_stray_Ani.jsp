...
// 					    // 或是 Object 定義更詳細的圖示
			            ,'icon': {
			            	 // 圖示網址
			                'url': 'https://i.imgur.com/8FvDIhA.png'
		                	// 縮放尺寸
...
<script type="text/javascript">
	function show_stray_Ani_details_page(pk_value) {
		var path_parameter = 'action=getOne_For_Display&Id=' + pk_value;
		var src='<%=request.getContextPath()%>/Heibernate_front-end/marker_detail_infowindow/stray_Ani_detail_page.jsp?'+path_parameter 
