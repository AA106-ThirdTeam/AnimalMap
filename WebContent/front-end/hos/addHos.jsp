...
<jsp:include page="js/textAreaStretch.txt" flush="true"/> 
...
<table border='1' cellpadding='5' cellspacing='0' width='400'>
	<tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
		...
		<td>
		   <a href="<%=request.getContextPath()%>/front-end/hos/select_page.jsp"><img src="js/avatar.jpg" width="100" height="100" border="1">回首頁</a>
	    </td>
	</tr>
</table>
...
<FORM method=post ACTION="hos.do" name="form1" enctype="multipart/form-data"  >
<table border="0">
