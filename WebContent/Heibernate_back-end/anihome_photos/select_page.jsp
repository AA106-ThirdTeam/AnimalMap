...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/Heibernate_back-end/anihome_photos/listAllAniHome_Photos.jsp'>List</a> all AniHome_Photoss. </li> <br><br>
  <li>
  ...
  <jsp:useBean id="anihome_photosSvc" scope="page" class="heibernate_com.anihome_photos.model.AniHome_PhotosService" />
  <li>
     <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/Heibernate_back-end/anihome_photos/anihome_photos.do" >
       <b>選擇動物之家相簿編號:</b>
...
<h3>動物之家相簿管理</h3>
<ul>
  <li><a href='<%=request.getContextPath()%>/Heibernate_back-end/anihome_photos/addAniHome_Photos.jsp'>Add</a> a new AniHome_Photos.</li>
</ul>
<!--  -->
	    <hr>
