...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/stray_ani_photos/listAllStray_Ani_photos.jsp'>List</a> all Stray_Ani_photoss. </li> <br><br>
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/stray_ani_photos/stray_ani_photos.do" name="form1">
      <b><font color=blue>萬用複合查詢:</font></b> <br>
       ...
       <br> 
        ...
        >
            <img align="middle" border="0" name="BTN_date"  src="<%=request.getContextPath()%>/back-end/images/btn_date_up.gif" width="22" height="17" alt="相片發布時間">
        </a>
        <br>
...
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/stray_ani_photos/addStray_Ani_photos.jsp'>Add</a> a new Stray_Ani_photos.</li>
</ul>
