...
<%
    ...
    List<AdpVO> list = adpSvc.getAll();
    pageContext.setAttribute("list",list);
%>

<html>
<head>
<title>所有領養活動資料 - listAllAdp.jsp</title>
	<!-- BS -->
...
<table class="table table-hover">
    <tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
        <td>
        <h3>所有領養活動資料 - ListAllAdp.jsp</h3>
        <a href="<%=request.getContextPath()%>/back-end/adp/select_page.jsp">
...
<table border='1' bordercolor='#CCCCFF' >
    ...
    <!-- 顯示查詢資料的部分 -->
    <c:forEach var="adpVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
