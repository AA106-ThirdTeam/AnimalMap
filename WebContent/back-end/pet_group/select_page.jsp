...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/pet_group/listAllPet_group.jsp'>List</a> all Pet_groups. </li> <br><br>
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/pet_group/pet_group.do" name="form1">
...
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/pet_group/addPet_group.jsp'>Add</a> a new Pet_group.</li>
</ul>
