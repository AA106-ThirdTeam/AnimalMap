...
<body bgcolor='white'>
	...
	<FORM METHOD="post" ACTION="grp.do" name="form1" method=post
		...
		<table border="0">
			...
			<tr>
				<td>揪團編號:</td>
				<td><input type="hidden" name="grp_Id" value="${grpVO.grp_Id}" />${grpVO.grp_Id}</td>
			</tr>
			<tr>
				<td>揪團名稱:</td>
			...
			<%
				...
				String now = new SimpleDateFormat("yyyy-MM-dd HH:mm a")
			...
			<%
				...
				byte[] imageByte = grpVO.getGrp_photo();
			...
			<tr>
				...
				<td><img id="blah" style="max-width: 100px; max-height: 100px"
					src="data:image/png;base64, <%=encodedText%>"> <input
					type="file" name="grp_photo" id="imgInp" /></td>
			</tr>


		</table>
		<br> <input type="hidden" name="action" value="update"> <input
			type="submit" value="送出新增"> <input type="hidden"
