...
<!--  -->
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/orders/listAllOrders.jsp'>List</a> all Orderss. </li> <br><br>
    ...
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/orders/orders.do" name="form1">
      <b><font color=blue>萬用複合查詢:</font></b> <br>
       ...
       <br> 
        ...
        >
            <img align="middle" border="0" name="BTN_date"  src="<%=request.getContextPath()%>/back-end/images/btn_date_up.gif" width="22" height="17" alt="下單日期">
        </a>
        <br>
        ...
        >
            <img align="middle" border="0" name="BTN_date"  src="<%=request.getContextPath()%>/back-end/images/btn_date_up.gif" width="22" height="17" alt="出貨日期">
        </a>
        <br>

      <input type="submit" value="送出">
      <input type="hidden" name="action" value="listOrderss_ByCompositeQuery">
    </FORM>
  </li>
</ul>
...
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/orders/addOrders.jsp'>Add</a> a new Orders.</li>
</ul>
