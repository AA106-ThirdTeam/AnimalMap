...
import jdbc.util.CompositeQuery.jdbcUtil_CompositeQuery_Pet;
/** 
 *表格名稱 : <br>
 *	自家寵物<br>
 *	英文:pet<br>
...
public class PetDAO implements PetDAO_interface{
	...
	//====以下是一般指令====
	public static final String INSERT_STMT = "INSERT INTO pet(pet_Id,mem_Id,pet_name,pet_type,pet_gender,pet_heal,pet_Vac,pet_color,pet_body,pet_age,pet_Neu,pet_chip,pet_birth,pet_status,pet_CreDATE,pet_city,pet_town,pet_road,pet_FinLat,pet_FinLon ) VALUES  ( pet_seq1.nextval , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ?  )  " ; 
	//====以下是更新指令====
	...
	public void update(PetVO aPetVO){
		...
		try {
			...
			pstmt.setString (19, aPetVO.getPet_Id());
			pstmt.executeUpdate();
		} catch (SQLException se) {
			throw new RuntimeException("A database error occured. " + se.getMessage());
		} finally {
	...
	@Override
	public PetVO findByPrimaryKey(String  aPK_NO){
		PetVO petVO = null; 
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
    ...
    public List<PetVO> getAll() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                list.add(petVO); // Store the row in the vector
            }
    ...
    public Set<PetVO> getPetsByMem_Id(String mem_Id) {
        Set<PetVO> set = new LinkedHashSet<PetVO>();
        PetVO petVO = null;
        ...
        try {
            ...
            con = ds.getConnection();
            pstmt = con.prepareStatement(GET_Pets_ByMem_Id_STMT);
            ...
            while (rs.next()) {
                ...
                set.add(petVO); // Store the row in the vector
            }
